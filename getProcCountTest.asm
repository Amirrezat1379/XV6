...
_getProcCountTest:     file format elf32-i386
...
int main(void) {
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    getProcCount();
  15:	e8 21 03 00 00       	call   33b <getProcCount>
    printf (1, "\nsuccessful!\n");
  1a:	83 ec 08             	sub    $0x8,%esp
  1d:	68 34 08 00 00       	push   $0x834
  22:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 42 08 00 00       	mov    $0x842,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 3c 0b 00 00       	mov    %eax,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 3c 0b 00 00       	mov    0xb3c,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 7a7:	53                   	push   %ebx
 7a8:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
 7ab:	68 00 20 00 00       	push   $0x2000
 7b0:	e8 db fe ff ff       	call   690 <malloc>
    void *stack;

    if (fptr == 0)
 7b5:	83 c4 10             	add    $0x10,%esp
 7b8:	85 c0                	test   %eax,%eax
 7ba:	74 59                	je     815 <thread_creator+0x75>
 7bc:	89 c3                	mov    %eax,%ebx
    ...
    if (mod == 0)
 7be:	25 ff 0f 00 00       	and    $0xfff,%eax
 7c3:	75 1b                	jne    7e0 <thread_creator+0x40>
        stack = fptr;
    else
 ...
 7c8:	53                   	push   %ebx
 7c9:	e8 7d fb ff ff       	call   34b <thread_create>

    if (thread_id < 0)
 7ce:	83 c4 10             	add    $0x10,%esp
 7d1:	85 c0                	test   %eax,%eax
 7d3:	78 23                	js     7f8 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
 7d5:	74 45                	je     81c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
 ...
 7dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        stack = fptr + (PAGESIZE - mod);
 7e0:	29 c3                	sub    %eax,%ebx
    int thread_id = thread_create((void*)stack);
 7e2:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
 7e5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 7eb:	53                   	push   %ebx
 7ec:	e8 5a fb ff ff       	call   34b <thread_create>
    if (thread_id < 0)
 7f1:	83 c4 10             	add    $0x10,%esp
 7f4:	85 c0                	test   %eax,%eax
 7f6:	79 dd                	jns    7d5 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
 7f8:	83 ec 08             	sub    $0x8,%esp
 7fb:	89 45 f4             	mov    %eax,-0xc(%ebp)
 7fe:	68 5d 08 00 00       	push   $0x85d
 803:	6a 01                	push   $0x1
 805:	e8 26 fc ff ff       	call   430 <printf>
 ...
 814:	c3                   	ret    
        return -1;
 815:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 81a:	eb bb                	jmp    7d7 <thread_creator+0x37>
        (fn)(args);
 81c:	83 ec 0c             	sub    $0xc,%esp
 81f:	ff 75 0c             	pushl  0xc(%ebp)
 822:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
 825:	89 1c 24             	mov    %ebx,(%esp)
 828:	e8 d3 fd ff ff       	call   600 <free>
        exit();
 82d:	e8 61 fa ff ff       	call   293 <exit>
