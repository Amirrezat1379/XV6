...
main(int argc, char *argv[])
{
  ...
  38:	68 84 08 00 00       	push   $0x884
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 86 08 00 00       	push   $0x886
  46:	6a 01                	push   $0x1
  ...
  57:	68 bd 08 00 00       	push   $0x8bd
  5c:	50                   	push   %eax
  5d:	68 86 08 00 00       	push   $0x886
  62:	6a 01                	push   $0x1
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 8b 08 00 00       	mov    $0x88b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 8c 0b 00 00       	mov    0xb8c,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 7d2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 818:	53                   	push   %ebx
 819:	e8 7d fb ff ff       	call   39b <thread_create>
 ...
 835:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 83b:	53                   	push   %ebx
 83c:	e8 5a fb ff ff       	call   39b <thread_create>
    if (thread_id < 0)
 ...
 878:	e8 d3 fd ff ff       	call   650 <free>
        exit();
 87d:	e8 61 fa ff ff       	call   2e3 <exit>
