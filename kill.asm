 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 88 08 00 00       	mov    $0x888,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 88 0b 00 00       	mov    %eax,0xb88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 88 0b 00 00       	mov    0xb88,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 7c2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 7e7:	53                   	push   %ebx
 7e8:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
 7eb:	68 00 20 00 00       	push   $0x2000
 7f0:	e8 db fe ff ff       	call   6d0 <malloc>
    void *stack;

    if (fptr == 0)
 7f5:	83 c4 10             	add    $0x10,%esp
 7f8:	85 c0                	test   %eax,%eax
 7fa:	74 59                	je     855 <thread_creator+0x75>
 7fc:	89 c3                	mov    %eax,%ebx
    ...
    if (mod == 0)
 7fe:	25 ff 0f 00 00       	and    $0xfff,%eax
 803:	75 1b                	jne    820 <thread_creator+0x40>
        stack = fptr;
    else
 ...
 808:	53                   	push   %ebx
 809:	e8 7d fb ff ff       	call   38b <thread_create>

    if (thread_id < 0)
 80e:	83 c4 10             	add    $0x10,%esp
 811:	85 c0                	test   %eax,%eax
 813:	78 23                	js     838 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
 815:	74 45                	je     85c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
 ...
 81c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        stack = fptr + (PAGESIZE - mod);
 820:	29 c3                	sub    %eax,%ebx
    int thread_id = thread_create((void*)stack);
 822:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
 825:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 82b:	53                   	push   %ebx
 82c:	e8 5a fb ff ff       	call   38b <thread_create>
    if (thread_id < 0)
 831:	83 c4 10             	add    $0x10,%esp
 834:	85 c0                	test   %eax,%eax
 836:	79 dd                	jns    815 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
 838:	83 ec 08             	sub    $0x8,%esp
 83b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 83e:	68 a1 08 00 00       	push   $0x8a1
 843:	6a 01                	push   $0x1
 845:	e8 26 fc ff ff       	call   470 <printf>
 ...
 85a:	eb bb                	jmp    817 <thread_creator+0x37>
        (fn)(args);
 85c:	83 ec 0c             	sub    $0xc,%esp
 85f:	ff 75 0c             	pushl  0xc(%ebp)
 862:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
 865:	89 1c 24             	mov    %ebx,(%esp)
 868:	e8 d3 fd ff ff       	call   640 <free>
        exit();
 86d:	e8 61 fa ff ff       	call   2d3 <exit>
