...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     12a:	68 d8 3f 00 00       	push   $0x3fd8
     12f:	ff 35 24 60 00 00    	pushl  0x6024
     135:	e8 06 3a 00 00       	call   3b40 <printf>
  if(mkdir("iputdir") < 0){
     13a:	c7 04 24 6b 3f 00 00 	movl   $0x3f6b,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     150:	68 6b 3f 00 00       	push   $0x3f6b
  ...
  if(unlink("../iputdir") < 0){
     ...
     168:	68 68 3f 00 00       	push   $0x3f68
  ...
  if(chdir("/") < 0){
     ...
     17c:	68 8d 3f 00 00       	push   $0x3f8d
  ...
  printf(stdout, "iput test ok\n");
     ...
     190:	68 10 40 00 00       	push   $0x4010
     195:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "mkdir failed\n");
     1a5:	50                   	push   %eax
     1a6:	50                   	push   %eax
     1a7:	68 44 3f 00 00       	push   $0x3f44
     1ac:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "chdir / failed\n");
     1bc:	50                   	push   %eax
     1bd:	50                   	push   %eax
     1be:	68 8f 3f 00 00       	push   $0x3f8f
     1c3:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1d3:	52                   	push   %edx
     1d4:	52                   	push   %edx
     1d5:	68 73 3f 00 00       	push   $0x3f73
     1da:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "chdir iputdir failed\n");
     1ea:	51                   	push   %ecx
     1eb:	51                   	push   %ecx
     1ec:	68 52 3f 00 00       	push   $0x3f52
     1f1:	ff 35 24 60 00 00    	pushl  0x6024
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     21a:	68 9f 3f 00 00       	push   $0x3f9f
     21f:	ff 35 24 60 00 00    	pushl  0x6024
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     23f:	68 6b 3f 00 00       	push   $0x3f6b
    ...
    if(chdir("iputdir") < 0){
     ...
     257:	68 6b 3f 00 00       	push   $0x3f6b
    ...
    if(unlink("../iputdir") < 0){
     ...
     26f:	68 68 3f 00 00       	push   $0x3f68
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     290:	68 c2 3f 00 00       	push   $0x3fc2
     295:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     2ab:	68 73 3f 00 00       	push   $0x3f73
     2b0:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "fork failed\n");
     2c0:	51                   	push   %ecx
     2c1:	51                   	push   %ecx
     2c2:	68 85 4e 00 00       	push   $0x4e85
     2c7:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    exit();
     ...
     2d7:	52                   	push   %edx
     2d8:	52                   	push   %edx
     2d9:	68 44 3f 00 00       	push   $0x3f44
     2de:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     2ee:	50                   	push   %eax
     2ef:	50                   	push   %eax
     2f0:	68 ae 3f 00 00       	push   $0x3fae
     2f5:	ff 35 24 60 00 00    	pushl  0x6024
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     31a:	68 d4 3f 00 00       	push   $0x3fd4
     31f:	ff 35 24 60 00 00    	pushl  0x6024
     325:	e8 16 38 00 00       	call   3b40 <printf>
  if(mkdir("oidir") < 0){
     32a:	c7 04 24 e3 3f 00 00 	movl   $0x3fe3,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     34f:	6a 02                	push   $0x2
     351:	68 e3 3f 00 00       	push   $0x3fe3
    ...
    if(fd >= 0){
     ...
     365:	68 68 4f 00 00       	push   $0x4f68
     36a:	ff 35 24 60 00 00    	pushl  0x6024
  ...
  if(unlink("oidir") != 0){
     38a:	c7 04 24 e3 3f 00 00 	movl   $0x3fe3,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3a5:	68 0c 40 00 00       	push   $0x400c
     3aa:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "fork failed\n");
     3c5:	52                   	push   %edx
     3c6:	52                   	push   %edx
     3c7:	68 85 4e 00 00       	push   $0x4e85
     3cc:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "mkdir oidir failed\n");
     3dc:	51                   	push   %ecx
     3dd:	51                   	push   %ecx
     3de:	68 e9 3f 00 00       	push   $0x3fe9
     3e3:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "unlink failed\n");
     3f3:	50                   	push   %eax
     3f4:	50                   	push   %eax
     3f5:	68 fd 3f 00 00       	push   $0x3ffd
     3fa:	ff 35 24 60 00 00    	pushl  0x6024
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     41a:	68 1e 40 00 00       	push   $0x401e
     41f:	ff 35 24 60 00 00    	pushl  0x6024
     425:	e8 16 37 00 00       	call   3b40 <printf>
  fd = open("echo", 0);
     42a:	58                   	pop    %eax
     42b:	5a                   	pop    %edx
     42c:	6a 00                	push   $0x0
     42e:	68 29 40 00 00       	push   $0x4029
  ...
  fd = open("doesnotexist", 0);
     ...
     449:	59                   	pop    %ecx
     44a:	6a 00                	push   $0x0
     44c:	68 41 40 00 00       	push   $0x4041
  ...
  printf(stdout, "open test ok\n");
     ...
     460:	68 6c 40 00 00       	push   $0x406c
     465:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "open echo failed!\n");
     475:	50                   	push   %eax
     476:	50                   	push   %eax
     477:	68 2e 40 00 00       	push   $0x402e
     47c:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     48c:	50                   	push   %eax
     48d:	50                   	push   %eax
     48e:	68 4e 40 00 00       	push   $0x404e
     493:	ff 35 24 60 00 00    	pushl  0x6024
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4bc:	68 7a 40 00 00       	push   $0x407a
     4c1:	ff 35 24 60 00 00    	pushl  0x6024
     4c7:	e8 74 36 00 00       	call   3b40 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4cc:	58                   	pop    %eax
     4cd:	5a                   	pop    %edx
     4ce:	68 02 02 00 00       	push   $0x202
     4d3:	68 8b 40 00 00       	push   $0x408b
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4ef:	68 91 40 00 00       	push   $0x4091
     4f4:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     50b:	6a 0a                	push   $0xa
     50d:	68 c8 40 00 00       	push   $0x40c8
     512:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     527:	6a 0a                	push   $0xa
     529:	68 d3 40 00 00       	push   $0x40d3
     52e:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     54b:	68 de 40 00 00       	push   $0x40de
     550:	ff 35 24 60 00 00    	pushl  0x6024
  ...
  fd = open("small", O_RDONLY);
     ...
     564:	5e                   	pop    %esi
     565:	6a 00                	push   $0x0
     567:	68 8b 40 00 00       	push   $0x408b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     581:	68 e9 40 00 00       	push   $0x40e9
     586:	ff 35 24 60 00 00    	pushl  0x6024
     58c:	e8 af 35 00 00       	call   3b40 <printf>
  i = read(fd, buf, 2000);
     591:	83 c4 0c             	add    $0xc,%esp
     594:	68 d0 07 00 00       	push   $0x7d0
     599:	68 00 88 00 00       	push   $0x8800
     59e:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5b5:	68 1d 41 00 00       	push   $0x411d
     5ba:	ff 35 24 60 00 00    	pushl  0x6024
     5c0:	e8 7b 35 00 00       	call   3b40 <printf>
  close(fd);
     5c5:	89 1c 24             	mov    %ebx,(%esp)
     5c8:	e8 de 33 00 00       	call   39ab <close>
  if(unlink("small") < 0){
     5cd:	c7 04 24 8b 40 00 00 	movl   $0x408b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e3:	68 45 41 00 00       	push   $0x4145
     5e8:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     600:	53                   	push   %ebx
     601:	68 8c 4f 00 00       	push   $0x4f8c
     606:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     619:	53                   	push   %ebx
     61a:	68 b0 4f 00 00       	push   $0x4fb0
     61f:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "error: open small failed!\n");
     62f:	51                   	push   %ecx
     630:	51                   	push   %ecx
     631:	68 02 41 00 00       	push   $0x4102
     636:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "read failed\n");
     646:	52                   	push   %edx
     647:	52                   	push   %edx
     648:	68 49 44 00 00       	push   $0x4449
     64d:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "unlink small failed\n");
     65d:	50                   	push   %eax
     65e:	50                   	push   %eax
     65f:	68 30 41 00 00       	push   $0x4130
     664:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "error: creat small failed!\n");
     674:	50                   	push   %eax
     675:	50                   	push   %eax
     676:	68 ac 40 00 00       	push   $0x40ac
     67b:	ff 35 24 60 00 00    	pushl  0x6024
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     69c:	68 59 41 00 00       	push   $0x4159
     6a1:	ff 35 24 60 00 00    	pushl  0x6024
     6a7:	e8 94 34 00 00       	call   3b40 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     6ac:	58                   	pop    %eax
     6ad:	5a                   	pop    %edx
     6ae:	68 02 02 00 00       	push   $0x202
     6b3:	68 d3 41 00 00       	push   $0x41d3
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6d3:	89 1d 00 88 00 00    	mov    %ebx,0x8800
    if(write(fd, buf, 512) != 512){
     6d9:	68 00 02 00 00       	push   $0x200
     6de:	68 00 88 00 00       	push   $0x8800
     6e3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     70c:	5e                   	pop    %esi
     70d:	6a 00                	push   $0x0
     70f:	68 d3 41 00 00       	push   $0x41d3
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     73b:	a1 00 88 00 00       	mov    0x8800,%eax
    ...
    i = read(fd, buf, 512);
     ...
     74f:	68 00 88 00 00       	push   $0x8800
     754:	53                   	push   %ebx
  ...
  if(unlink("big") < 0){
     776:	c7 04 24 d3 41 00 00 	movl   $0x41d3,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     790:	68 fa 41 00 00       	push   $0x41fa
     795:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     7ad:	53                   	push   %ebx
     7ae:	68 83 41 00 00       	push   $0x4183
     7b3:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     7c3:	50                   	push   %eax
     7c4:	56                   	push   %esi
     7c5:	68 d4 4f 00 00       	push   $0x4fd4
     7ca:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     7dd:	50                   	push   %eax
     7de:	68 d7 41 00 00       	push   $0x41d7
     7e3:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     7f9:	68 ba 41 00 00       	push   $0x41ba
     7fe:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "error: open big failed!\n");
     80e:	51                   	push   %ecx
     80f:	51                   	push   %ecx
     810:	68 a1 41 00 00       	push   $0x41a1
     815:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "error: creat big failed!\n");
     825:	50                   	push   %eax
     826:	50                   	push   %eax
     827:	68 69 41 00 00       	push   $0x4169
     82c:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "unlink big failed\n");
     83c:	50                   	push   %eax
     83d:	50                   	push   %eax
     83e:	68 e7 41 00 00       	push   $0x41e7
     843:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     870:	68 f4 4f 00 00       	push   $0x4ff4
     875:	ff 35 24 60 00 00    	pushl  0x6024
     87b:	e8 c0 32 00 00       	call   3b40 <printf>
  name[0] = 'a';
     880:	c6 05 00 a8 00 00 61 	movb   $0x61,0xa800
  name[2] = '\0';
     887:	83 c4 10             	add    $0x10,%esp
     88a:	c6 05 02 a8 00 00 00 	movb   $0x0,0xa802
  for(i = 0; i < 52; i++){
     891:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    fd = open(name, O_CREATE|O_RDWR);
     898:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     89b:	88 1d 01 a8 00 00    	mov    %bl,0xa801
    fd = open(name, O_CREATE|O_RDWR);
     8a1:	83 c3 01             	add    $0x1,%ebx
     8a4:	68 02 02 00 00       	push   $0x202
     8a9:	68 00 a8 00 00       	push   $0xa800
  ...
  name[0] = 'a';
     8c3:	c6 05 00 a8 00 00 61 	movb   $0x61,0xa800
  name[2] = '\0';
     8ca:	bb 30 00 00 00       	mov    $0x30,%ebx
     8cf:	c6 05 02 a8 00 00 00 	movb   $0x0,0xa802
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     8e3:	88 1d 01 a8 00 00    	mov    %bl,0xa801
    unlink(name);
     8e9:	83 c3 01             	add    $0x1,%ebx
     8ec:	68 00 a8 00 00       	push   $0xa800
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     901:	68 1c 50 00 00       	push   $0x501c
     906:	ff 35 24 60 00 00    	pushl  0x6024
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     92a:	68 08 42 00 00       	push   $0x4208
     92f:	ff 35 24 60 00 00    	pushl  0x6024
     935:	e8 06 32 00 00       	call   3b40 <printf>
  if(mkdir("dir0") < 0){
     93a:	c7 04 24 14 42 00 00 	movl   $0x4214,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     950:	68 14 42 00 00       	push   $0x4214
  ...
  if(chdir("..") < 0){
     ...
     968:	68 b9 47 00 00       	push   $0x47b9
  ...
  if(unlink("dir0") < 0){
     ...
     97c:	68 14 42 00 00       	push   $0x4214
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     990:	68 51 42 00 00       	push   $0x4251
     995:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "mkdir failed\n");
     9a5:	50                   	push   %eax
     9a6:	50                   	push   %eax
     9a7:	68 44 3f 00 00       	push   $0x3f44
     9ac:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "unlink dir0 failed\n");
     9bc:	50                   	push   %eax
     9bd:	50                   	push   %eax
     9be:	68 3d 42 00 00       	push   $0x423d
     9c3:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "chdir .. failed\n");
     9d3:	52                   	push   %edx
     9d4:	52                   	push   %edx
     9d5:	68 2c 42 00 00       	push   $0x422c
     9da:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    printf(stdout, "chdir dir0 failed\n");
     9ea:	51                   	push   %ecx
     9eb:	51                   	push   %ecx
     9ec:	68 19 42 00 00       	push   $0x4219
     9f1:	ff 35 24 60 00 00    	pushl  0x6024
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a1a:	68 60 42 00 00       	push   $0x4260
     a1f:	ff 35 24 60 00 00    	pushl  0x6024
     a25:	e8 16 31 00 00       	call   3b40 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 28 60 00 00       	push   $0x6028
     a31:	68 29 40 00 00       	push   $0x4029
    ...
    printf(stdout, "exec echo failed\n");
     a44:	50                   	push   %eax
     a45:	50                   	push   %eax
     a46:	68 6b 42 00 00       	push   $0x426b
     a4b:	ff 35 24 60 00 00    	pushl  0x6024
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ab3:	56                   	push   %esi
     ab4:	68 00 88 00 00       	push   $0x8800
     ...
     add:	38 90 00 88 00 00    	cmp    %dl,0x8800(%eax)
     ...
     b04:	68 9a 42 00 00       	push   $0x429a
     b09:	6a 01                	push   $0x1
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     b33:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     b36:	88 90 ff 87 00 00    	mov    %dl,0x87ff(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b51:	68 00 88 00 00       	push   $0x8800
  ...
  printf(1, "pipe1 ok\n");
     b8e:	5a                   	pop    %edx
     b8f:	59                   	pop    %ecx
     b90:	68 bf 42 00 00       	push   $0x42bf
     b95:	6a 01                	push   $0x1
     ...
     ba8:	68 a8 42 00 00       	push   $0x42a8
     bad:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     bb9:	57                   	push   %edi
     bba:	57                   	push   %edi
     bbb:	68 7d 42 00 00       	push   $0x427d
     bc0:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     bcc:	50                   	push   %eax
     bcd:	50                   	push   %eax
     bce:	68 c9 42 00 00       	push   $0x42c9
     bd3:	6a 01                	push   $0x1
    ...
    exit();
     ...
     bdf:	56                   	push   %esi
     be0:	56                   	push   %esi
     be1:	68 8c 42 00 00       	push   $0x428c
     be6:	6a 01                	push   $0x1
...
00000c00 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c0d:	68 d8 42 00 00       	push   $0x42d8
     c12:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c68:	6a 01                	push   $0x1
     c6a:	68 9d 48 00 00       	push   $0x489d
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     cab:	68 00 88 00 00       	push   $0x8800
  ...
  printf(1, "kill... ");
     ccb:	58                   	pop    %eax
     ccc:	5a                   	pop    %edx
     ccd:	68 09 43 00 00       	push   $0x4309
     cd2:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     cf1:	59                   	pop    %ecx
     cf2:	5b                   	pop    %ebx
     cf3:	68 12 43 00 00       	push   $0x4312
     cf8:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     d0e:	5e                   	pop    %esi
     d0f:	5f                   	pop    %edi
     d10:	68 1b 43 00 00       	push   $0x431b
     d15:	6a 01                	push   $0x1
     ...
     d2a:	68 e2 42 00 00       	push   $0x42e2
     d2f:	6a 01                	push   $0x1
    ...
    printf(1, "preempt read error");
     ...
     d41:	68 f6 42 00 00       	push   $0x42f6
     d46:	6a 01                	push   $0x1
...
00000d60 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d8e:	68 85 4e 00 00       	push   $0x4e85
     d93:	6a 01                	push   $0x1
     ...
     dab:	68 27 43 00 00       	push   $0x4327
     db0:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     dc4:	68 37 43 00 00       	push   $0x4337
     dc9:	6a 01                	push   $0x1
...
00000de0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     dee:	68 44 43 00 00       	push   $0x4344
     df3:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e69:	58                   	pop    %eax
     e6a:	5a                   	pop    %edx
     e6b:	68 68 43 00 00       	push   $0x4368
     e70:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e83:	68 4e 43 00 00       	push   $0x434e
     e88:	6a 01                	push   $0x1
...
00000eb0 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f3c:	68 70 50 00 00       	push   $0x5070
     f41:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     f6a:	5a                   	pop    %edx
     f6b:	6a 00                	push   $0x0
     f6d:	68 7f 43 00 00       	push   $0x437f
  ...
  unlink("sharedfd");
     fdb:	c7 04 24 7f 43 00 00 	movl   $0x437f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    1000:	68 88 43 00 00       	push   $0x4388
    1005:	6a 01                	push   $0x1
    ...
    101a:	68 44 50 00 00       	push   $0x5044
    101f:	6a 01                	push   $0x1
    ...
    1034:	68 90 50 00 00       	push   $0x5090
    1039:	6a 01                	push   $0x1
    ...
    1050:	53                   	push   %ebx
    1051:	52                   	push   %edx
    1052:	68 95 43 00 00       	push   $0x4395
    1057:	6a 01                	push   $0x1
...
00001070 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1079:	be aa 43 00 00       	mov    $0x43aa,%esi
{
    107e:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1084:	c7 45 d8 aa 43 00 00 	movl   $0x43aa,-0x28(%ebp)
  printf(1, "fourfiles test\n");
    108b:	68 b0 43 00 00       	push   $0x43b0
    1090:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1092:	c7 45 dc f3 44 00 00 	movl   $0x44f3,-0x24(%ebp)
    1099:	c7 45 e0 f7 44 00 00 	movl   $0x44f7,-0x20(%ebp)
    10a0:	c7 45 e4 ad 43 00 00 	movl   $0x43ad,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    1118:	68 00 88 00 00       	push   $0x8800
    ...
    1133:	0f be ba 00 88 00 00 	movsbl 0x8800(%edx),%edi
  ...
  printf(1, "fourfiles ok\n");
    ...
    117e:	68 ee 43 00 00       	push   $0x43ee
    1183:	6a 01                	push   $0x1
    ...
    11a2:	68 d1 43 00 00       	push   $0x43d1
    11a7:	6a 01                	push   $0x1
    ...
    11db:	68 00 88 00 00       	push   $0x8800
    ...
    11f0:	68 00 88 00 00       	push   $0x8800
    11f5:	56                   	push   %esi
    ...
    120f:	51                   	push   %ecx
    1210:	51                   	push   %ecx
    1211:	68 4b 46 00 00       	push   $0x464b
    1216:	6a 01                	push   $0x1
    ...
    122b:	68 85 4e 00 00       	push   $0x4e85
    1230:	6a 01                	push   $0x1
    ...
    123c:	50                   	push   %eax
    123d:	53                   	push   %ebx
    123e:	68 dd 43 00 00       	push   $0x43dd
    1243:	6a 01                	push   $0x1
    ...
    124f:	52                   	push   %edx
    1250:	50                   	push   %eax
    1251:	68 c0 43 00 00       	push   $0x43c0
    1256:	6a 01                	push   $0x1
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    127f:	68 fc 43 00 00       	push   $0x43fc
    1284:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1384:	68 0f 44 00 00       	push   $0x440f
    1389:	6a 01                	push   $0x1
    ...
    1422:	52                   	push   %edx
    1423:	52                   	push   %edx
    1424:	68 fd 3f 00 00       	push   $0x3ffd
    1429:	6a 01                	push   $0x1
    ...
    1443:	57                   	push   %edi
    1444:	68 bc 50 00 00       	push   $0x50bc
    1449:	6a 01                	push   $0x1
    ...
    1458:	68 4b 46 00 00       	push   $0x464b
    145d:	6a 01                	push   $0x1
    ...
    146c:	68 85 4e 00 00       	push   $0x4e85
    1471:	6a 01                	push   $0x1
    ...
    1488:	50                   	push   %eax
    1489:	57                   	push   %edi
    148a:	68 e0 50 00 00       	push   $0x50e0
    148f:	6a 01                	push   $0x1
...
000014a0 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    14ac:	68 20 44 00 00       	push   $0x4420
    14b1:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14bf:	68 31 44 00 00       	push   $0x4431
  ...
  write(fd, "hello", 5);
    ...
    14d9:	6a 05                	push   $0x5
    14db:	68 56 44 00 00       	push   $0x4456
    14e0:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 31 44 00 00       	push   $0x4431
  ...
  if(unlink("unlinkread") != 0){
    ...
    150c:	68 31 44 00 00       	push   $0x4431
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1529:	68 31 44 00 00       	push   $0x4431
  ...
  write(fd1, "yyy", 3);
    153a:	68 8e 44 00 00       	push   $0x448e
    153f:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1555:	68 00 88 00 00       	push   $0x8800
    155a:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    156c:	80 3d 00 88 00 00 68 	cmpb   $0x68,0x8800
    1573:	75 6b                	jne    15e0 <unlinkread+0x140>
  if(write(fd, buf, 10) != 10){
    1575:	83 ec 04             	sub    $0x4,%esp
    1578:	6a 0a                	push   $0xa
    157a:	68 00 88 00 00       	push   $0x8800
    157f:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1596:	c7 04 24 31 44 00 00 	movl   $0x4431,(%esp)
    159d:	e8 31 24 00 00       	call   39d3 <unlink>
  printf(1, "unlinkread ok\n");
    15a2:	58                   	pop    %eax
    15a3:	5a                   	pop    %edx
    15a4:	68 d9 44 00 00       	push   $0x44d9
    15a9:	6a 01                	push   $0x1
    ...
    15ba:	51                   	push   %ecx
    15bb:	51                   	push   %ecx
    15bc:	68 3c 44 00 00       	push   $0x443c
    15c1:	6a 01                	push   $0x1
    ...
    15cd:	51                   	push   %ecx
    15ce:	51                   	push   %ecx
    15cf:	68 c0 44 00 00       	push   $0x44c0
    15d4:	6a 01                	push   $0x1
    ...
    15e0:	53                   	push   %ebx
    15e1:	53                   	push   %ebx
    15e2:	68 a9 44 00 00       	push   $0x44a9
    15e7:	6a 01                	push   $0x1
    ...
    15f3:	56                   	push   %esi
    15f4:	56                   	push   %esi
    15f5:	68 92 44 00 00       	push   $0x4492
    15fa:	6a 01                	push   $0x1
    ...
    1606:	50                   	push   %eax
    1607:	50                   	push   %eax
    1608:	68 74 44 00 00       	push   $0x4474
    160d:	6a 01                	push   $0x1
    ...
    1619:	50                   	push   %eax
    161a:	50                   	push   %eax
    161b:	68 5c 44 00 00       	push   $0x445c
    1620:	6a 01                	push   $0x1
...
00001630 <linktest>:
{
  ...
  printf(1, "linktest\n");
    163b:	68 e8 44 00 00       	push   $0x44e8
    1640:	6a 01                	push   $0x1
    1642:	e8 f9 24 00 00       	call   3b40 <printf>
  unlink("lf1");
    1647:	c7 04 24 f2 44 00 00 	movl   $0x44f2,(%esp)
    164e:	e8 80 23 00 00       	call   39d3 <unlink>
  unlink("lf2");
    1653:	c7 04 24 f6 44 00 00 	movl   $0x44f6,(%esp)
    165a:	e8 74 23 00 00       	call   39d3 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    165f:	58                   	pop    %eax
    1660:	5a                   	pop    %edx
    1661:	68 02 02 00 00       	push   $0x202
    1666:	68 f2 44 00 00       	push   $0x44f2
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1680:	6a 05                	push   $0x5
    1682:	68 56 44 00 00       	push   $0x4456
    1687:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 f6 44 00 00       	push   $0x44f6
    16a9:	68 f2 44 00 00       	push   $0x44f2
  ...
  unlink("lf1");
    ...
    16c1:	68 f2 44 00 00       	push   $0x44f2
    16c6:	e8 08 23 00 00       	call   39d3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 f2 44 00 00       	push   $0x44f2
  ...
  fd = open("lf2", 0);
    ...
    16e7:	6a 00                	push   $0x0
    16e9:	68 f6 44 00 00       	push   $0x44f6
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1708:	68 00 88 00 00       	push   $0x8800
    170d:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 f6 44 00 00       	push   $0x44f6
    172f:	68 f6 44 00 00       	push   $0x44f6
  ...
  unlink("lf2");
    ...
    1747:	68 f6 44 00 00       	push   $0x44f6
    174c:	e8 82 22 00 00       	call   39d3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 f2 44 00 00       	push   $0x44f2
    1758:	68 f6 44 00 00       	push   $0x44f6
  ...
  if(link(".", "lf1") >= 0){
    ...
    176c:	68 f2 44 00 00       	push   $0x44f2
    1771:	68 ba 47 00 00       	push   $0x47ba
  ...
  printf(1, "linktest ok\n");
    ...
    1785:	68 90 45 00 00       	push   $0x4590
    178a:	6a 01                	push   $0x1
    ...
    1799:	50                   	push   %eax
    179a:	50                   	push   %eax
    179b:	68 fa 44 00 00       	push   $0x44fa
    17a0:	6a 01                	push   $0x1
    ...
    17ac:	50                   	push   %eax
    17ad:	50                   	push   %eax
    17ae:	68 74 45 00 00       	push   $0x4574
    17b3:	6a 01                	push   $0x1
    ...
    17bf:	52                   	push   %edx
    17c0:	52                   	push   %edx
    17c1:	68 28 51 00 00       	push   $0x5128
    17c6:	6a 01                	push   $0x1
    ...
    17d2:	50                   	push   %eax
    17d3:	50                   	push   %eax
    17d4:	68 56 45 00 00       	push   $0x4556
    17d9:	6a 01                	push   $0x1
    ...
    17e5:	51                   	push   %ecx
    17e6:	51                   	push   %ecx
    17e7:	68 45 45 00 00       	push   $0x4545
    17ec:	6a 01                	push   $0x1
    ...
    17f8:	53                   	push   %ebx
    17f9:	53                   	push   %ebx
    17fa:	68 34 45 00 00       	push   $0x4534
    17ff:	6a 01                	push   $0x1
    ...
    180b:	50                   	push   %eax
    180c:	50                   	push   %eax
    180d:	68 00 51 00 00       	push   $0x5100
    1812:	6a 01                	push   $0x1
    ...
    181e:	51                   	push   %ecx
    181f:	51                   	push   %ecx
    1820:	68 1f 45 00 00       	push   $0x451f
    1825:	6a 01                	push   $0x1
    ...
    1831:	50                   	push   %eax
    1832:	50                   	push   %eax
    1833:	68 0d 45 00 00       	push   $0x450d
    1838:	6a 01                	push   $0x1
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    1862:	68 9d 45 00 00       	push   $0x459d
    1867:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1908:	53                   	push   %ebx
    1909:	68 b0 45 00 00       	push   $0x45b0
    190e:	6a 01                	push   $0x1
    ...
    1923:	53                   	push   %ebx
    1924:	68 ad 45 00 00       	push   $0x45ad
  ...
  for(i = 0; i < 40; i++){
    1943:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1946:	53                   	push   %ebx
    1947:	68 ad 45 00 00       	push   $0x45ad
  ...
  fd = open(".", 0);
    ...
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
    1976:	68 ba 47 00 00       	push   $0x47ba
  ...
  printf(1, "concreate ok\n");
    ...
    1ad3:	68 02 46 00 00       	push   $0x4602
    1ad8:	6a 01                	push   $0x1
    ...
    1aea:	68 85 4e 00 00       	push   $0x4e85
    1aef:	6a 01                	push   $0x1
    ...
    1afb:	51                   	push   %ecx
    1afc:	51                   	push   %ecx
    1afd:	68 4c 51 00 00       	push   $0x514c
    1b02:	6a 01                	push   $0x1
    ...
    1b14:	50                   	push   %eax
    1b15:	68 e5 45 00 00       	push   $0x45e5
    1b1a:	6a 01                	push   $0x1
    ...
    1b2c:	50                   	push   %eax
    1b2d:	68 cc 45 00 00       	push   $0x45cc
    1b32:	6a 01                	push   $0x1
...
00001b50 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1b5d:	68 10 46 00 00       	push   $0x4610
    1b62:	6a 01                	push   $0x1
    1b64:	e8 d7 1f 00 00       	call   3b40 <printf>
  unlink("x");
    1b69:	c7 04 24 9d 48 00 00 	movl   $0x489d,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ba8:	68 9d 48 00 00       	push   $0x489d
  ...
  for(i = 0; i < 100; i++){
    ...
    1be1:	68 9d 48 00 00       	push   $0x489d
  ...
  printf(1, "linkunlink ok\n");
    ...
    1c0a:	68 25 46 00 00       	push   $0x4625
    1c0f:	6a 01                	push   $0x1
    ...
    1c23:	68 9d 48 00 00       	push   $0x489d
    1c28:	68 21 46 00 00       	push   $0x4621
    ...
    1c3a:	52                   	push   %edx
    1c3b:	52                   	push   %edx
    1c3c:	68 85 4e 00 00       	push   $0x4e85
    1c41:	6a 01                	push   $0x1
...
00001c60 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1c6d:	68 34 46 00 00       	push   $0x4634
    1c72:	6a 01                	push   $0x1
    1c74:	e8 c7 1e 00 00       	call   3b40 <printf>
  unlink("bd");
    1c79:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
    1c80:	e8 4e 1d 00 00       	call   39d3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 41 46 00 00       	push   $0x4641
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1cc8:	68 41 46 00 00       	push   $0x4641
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1cfb:	68 41 46 00 00       	push   $0x4641
  ...
  printf(1, "bigdir ok\n");
    ...
    1d4c:	68 83 46 00 00       	push   $0x4683
    1d51:	6a 01                	push   $0x1
    ...
    1d66:	68 5a 46 00 00       	push   $0x465a
    1d6b:	6a 01                	push   $0x1
    ...
    1d7a:	68 6e 46 00 00       	push   $0x466e
    1d7f:	6a 01                	push   $0x1
    ...
    1d8b:	50                   	push   %eax
    1d8c:	50                   	push   %eax
    1d8d:	68 44 46 00 00       	push   $0x4644
    1d92:	6a 01                	push   $0x1
...
00001da0 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1dab:	68 8e 46 00 00       	push   $0x468e
    1db0:	6a 01                	push   $0x1
    1db2:	e8 89 1d 00 00       	call   3b40 <printf>
  unlink("ff");
    1db7:	c7 04 24 17 47 00 00 	movl   $0x4717,(%esp)
    1dbe:	e8 10 1c 00 00       	call   39d3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 b4 47 00 00 	movl   $0x47b4,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de2:	68 ed 46 00 00       	push   $0x46ed
  ...
  write(fd, "ff", 2);
    ...
    1dfc:	6a 02                	push   $0x2
    1dfe:	68 17 47 00 00       	push   $0x4717
    1e03:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 b4 47 00 00 	movl   $0x47b4,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e2b:	68 c8 46 00 00       	push   $0x46c8
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e48:	68 ea 46 00 00       	push   $0x46ea
  ...
  write(fd, "FF", 2);
    ...
    1e62:	6a 02                	push   $0x2
    1e64:	68 0b 47 00 00       	push   $0x470b
    1e69:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 0e 47 00 00       	push   $0x470e
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e9a:	68 00 88 00 00       	push   $0x8800
    1e9f:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1eb1:	80 3d 00 88 00 00 66 	cmpb   $0x66,0x8800
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1ec7:	59                   	pop    %ecx
    1ec8:	5b                   	pop    %ebx
    1ec9:	68 4e 47 00 00       	push   $0x474e
    1ece:	68 ea 46 00 00       	push   $0x46ea
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1ee6:	68 ea 46 00 00       	push   $0x46ea
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1efe:	6a 00                	push   $0x0
    1f00:	68 ea 46 00 00       	push   $0x46ea
  ...
  if(chdir("dd") != 0){
    ...
    1f18:	68 b4 47 00 00       	push   $0x47b4
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f30:	68 82 47 00 00       	push   $0x4782
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f48:	68 a8 47 00 00       	push   $0x47a8
  ...
  if(chdir("./..") != 0){
    ...
    1f60:	68 b7 47 00 00       	push   $0x47b7
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f78:	6a 00                	push   $0x0
    1f7a:	68 4e 47 00 00       	push   $0x474e
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f99:	68 00 88 00 00       	push   $0x8800
    1f9e:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 ea 46 00 00       	push   $0x46ea
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fda:	68 02 48 00 00       	push   $0x4802
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ff7:	68 27 48 00 00       	push   $0x4827
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2014:	68 b4 47 00 00       	push   $0x47b4
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    202c:	6a 02                	push   $0x2
    202e:	68 b4 47 00 00       	push   $0x47b4
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2046:	6a 01                	push   $0x1
    2048:	68 b4 47 00 00       	push   $0x47b4
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2060:	68 96 48 00 00       	push   $0x4896
    2065:	68 02 48 00 00       	push   $0x4802
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    207d:	68 96 48 00 00       	push   $0x4896
    2082:	68 27 48 00 00       	push   $0x4827
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    209a:	68 4e 47 00 00       	push   $0x474e
    209f:	68 ed 46 00 00       	push   $0x46ed
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    20b7:	68 02 48 00 00       	push   $0x4802
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    20cf:	68 27 48 00 00       	push   $0x4827
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20e7:	68 4e 47 00 00       	push   $0x474e
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    20ff:	68 27 48 00 00       	push   $0x4827
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2117:	68 02 48 00 00       	push   $0x4802
  ...
  if(chdir("dd/ff") == 0){
    ...
    212f:	68 ed 46 00 00       	push   $0x46ed
  ...
  if(chdir("dd/xx") == 0){
    ...
    2147:	68 99 48 00 00       	push   $0x4899
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    215f:	68 4e 47 00 00       	push   $0x474e
  ...
  if(unlink("dd/ff") != 0){
    ...
    2177:	68 ed 46 00 00       	push   $0x46ed
  ...
  if(unlink("dd") == 0){
    ...
    218f:	68 b4 47 00 00       	push   $0x47b4
  ...
  if(unlink("dd/dd") < 0){
    ...
    21a7:	68 c9 46 00 00       	push   $0x46c9
  ...
  if(unlink("dd") < 0){
    ...
    21bf:	68 b4 47 00 00       	push   $0x47b4
  ...
  printf(1, "subdir ok\n");
    ...
    21d7:	68 96 49 00 00       	push   $0x4996
    21dc:	6a 01                	push   $0x1
    ...
    21eb:	50                   	push   %eax
    21ec:	50                   	push   %eax
    21ed:	68 33 47 00 00       	push   $0x4733
    21f2:	6a 01                	push   $0x1
    ...
    21fe:	50                   	push   %eax
    21ff:	50                   	push   %eax
    2200:	68 8e 47 00 00       	push   $0x478e
    2205:	6a 01                	push   $0x1
    ...
    2211:	50                   	push   %eax
    2212:	50                   	push   %eax
    2213:	68 59 47 00 00       	push   $0x4759
    2218:	6a 01                	push   $0x1
    ...
    2224:	51                   	push   %ecx
    2225:	51                   	push   %ecx
    2226:	68 0b 48 00 00       	push   $0x480b
    222b:	6a 01                	push   $0x1
    ...
    2237:	53                   	push   %ebx
    2238:	53                   	push   %ebx
    2239:	68 f0 51 00 00       	push   $0x51f0
    223e:	6a 01                	push   $0x1
    ...
    224a:	51                   	push   %ecx
    224b:	51                   	push   %ecx
    224c:	68 9f 48 00 00       	push   $0x489f
    2251:	6a 01                	push   $0x1
    ...
    225d:	53                   	push   %ebx
    225e:	53                   	push   %ebx
    225f:	68 60 52 00 00       	push   $0x5260
    2264:	6a 01                	push   $0x1
    ...
    2270:	50                   	push   %eax
    2271:	50                   	push   %eax
    2272:	68 1a 47 00 00       	push   $0x471a
    2277:	6a 01                	push   $0x1
    ...
    2283:	51                   	push   %ecx
    2284:	51                   	push   %ecx
    2285:	68 f3 46 00 00       	push   $0x46f3
    228a:	6a 01                	push   $0x1
    ...
    2296:	50                   	push   %eax
    2297:	50                   	push   %eax
    2298:	68 bc 47 00 00       	push   $0x47bc
    229d:	6a 01                	push   $0x1
    ...
    22a9:	52                   	push   %edx
    22aa:	52                   	push   %edx
    22ab:	68 a8 51 00 00       	push   $0x51a8
    22b0:	6a 01                	push   $0x1
    ...
    22bc:	50                   	push   %eax
    22bd:	50                   	push   %eax
    22be:	68 3c 52 00 00       	push   $0x523c
    22c3:	6a 01                	push   $0x1
    ...
    22cf:	50                   	push   %eax
    22d0:	50                   	push   %eax
    22d1:	68 18 52 00 00       	push   $0x5218
    22d6:	6a 01                	push   $0x1
    ...
    22e2:	50                   	push   %eax
    22e3:	50                   	push   %eax
    22e4:	68 7b 48 00 00       	push   $0x487b
    22e9:	6a 01                	push   $0x1
    ...
    22f5:	50                   	push   %eax
    22f6:	50                   	push   %eax
    22f7:	68 62 48 00 00       	push   $0x4862
    22fc:	6a 01                	push   $0x1
    ...
    2308:	50                   	push   %eax
    2309:	50                   	push   %eax
    230a:	68 4c 48 00 00       	push   $0x484c
    230f:	6a 01                	push   $0x1
    ...
    231b:	52                   	push   %edx
    231c:	52                   	push   %edx
    231d:	68 30 48 00 00       	push   $0x4830
    2322:	6a 01                	push   $0x1
    ...
    232e:	50                   	push   %eax
    232f:	50                   	push   %eax
    2330:	68 71 47 00 00       	push   $0x4771
    2335:	6a 01                	push   $0x1
    ...
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    2343:	68 cc 51 00 00       	push   $0x51cc
    2348:	6a 01                	push   $0x1
    ...
    2354:	53                   	push   %ebx
    2355:	53                   	push   %ebx
    2356:	68 cf 46 00 00       	push   $0x46cf
    235b:	6a 01                	push   $0x1
    ...
    2367:	50                   	push   %eax
    2368:	50                   	push   %eax
    2369:	68 80 51 00 00       	push   $0x5180
    236e:	6a 01                	push   $0x1
    ...
    237a:	50                   	push   %eax
    237b:	50                   	push   %eax
    237c:	68 b3 46 00 00       	push   $0x46b3
    2381:	6a 01                	push   $0x1
    ...
    238d:	50                   	push   %eax
    238e:	50                   	push   %eax
    238f:	68 9b 46 00 00       	push   $0x469b
    2394:	6a 01                	push   $0x1
    ...
    23a0:	50                   	push   %eax
    23a1:	50                   	push   %eax
    23a2:	68 84 49 00 00       	push   $0x4984
    23a7:	6a 01                	push   $0x1
    ...
    23b3:	52                   	push   %edx
    23b4:	52                   	push   %edx
    23b5:	68 6f 49 00 00       	push   $0x496f
    23ba:	6a 01                	push   $0x1
    ...
    23c6:	51                   	push   %ecx
    23c7:	51                   	push   %ecx
    23c8:	68 84 52 00 00       	push   $0x5284
    23cd:	6a 01                	push   $0x1
    ...
    23d9:	53                   	push   %ebx
    23da:	53                   	push   %ebx
    23db:	68 5a 49 00 00       	push   $0x495a
    23e0:	6a 01                	push   $0x1
    ...
    23ec:	50                   	push   %eax
    23ed:	50                   	push   %eax
    23ee:	68 42 49 00 00       	push   $0x4942
    23f3:	6a 01                	push   $0x1
    ...
    23ff:	50                   	push   %eax
    2400:	50                   	push   %eax
    2401:	68 2a 49 00 00       	push   $0x492a
    2406:	6a 01                	push   $0x1
    ...
    2412:	50                   	push   %eax
    2413:	50                   	push   %eax
    2414:	68 0e 49 00 00       	push   $0x490e
    2419:	6a 01                	push   $0x1
    ...
    2425:	50                   	push   %eax
    2426:	50                   	push   %eax
    2427:	68 f2 48 00 00       	push   $0x48f2
    242c:	6a 01                	push   $0x1
    ...
    2438:	50                   	push   %eax
    2439:	50                   	push   %eax
    243a:	68 d5 48 00 00       	push   $0x48d5
    243f:	6a 01                	push   $0x1
    ...
    244b:	52                   	push   %edx
    244c:	52                   	push   %edx
    244d:	68 ba 48 00 00       	push   $0x48ba
    2452:	6a 01                	push   $0x1
    ...
    245e:	51                   	push   %ecx
    245f:	51                   	push   %ecx
    2460:	68 e7 47 00 00       	push   $0x47e7
    2465:	6a 01                	push   $0x1
    ...
    2471:	53                   	push   %ebx
    2472:	53                   	push   %ebx
    2473:	68 cf 47 00 00       	push   $0x47cf
    2478:	6a 01                	push   $0x1
...
00002490 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    24a1:	68 a1 49 00 00       	push   $0x49a1
    24a6:	6a 01                	push   $0x1
    24a8:	e8 93 16 00 00       	call   3b40 <printf>
  unlink("bigwrite");
    24ad:	c7 04 24 b0 49 00 00 	movl   $0x49b0,(%esp)
    ...
    24c8:	68 b0 49 00 00       	push   $0x49b0
    ...
    24de:	53                   	push   %ebx
    24df:	68 00 88 00 00       	push   $0x8800
    24e4:	50                   	push   %eax
    ...
    24f4:	53                   	push   %ebx
    24f5:	68 00 88 00 00       	push   $0x8800
    24fa:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2516:	c7 04 24 b0 49 00 00 	movl   $0x49b0,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2530:	68 e3 49 00 00       	push   $0x49e3
    2535:	6a 01                	push   $0x1
    ...
    2546:	50                   	push   %eax
    2547:	53                   	push   %ebx
    2548:	68 d1 49 00 00       	push   $0x49d1
    254d:	6a 01                	push   $0x1
    ...
    255c:	68 b9 49 00 00       	push   $0x49b9
    2561:	6a 01                	push   $0x1
...
00002570 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 0c 4a 00 00       	push   $0x4a0c
  ...
  for(i = 0; ; i++){
    ...
    262d:	0f be 05 00 88 00 00 	movsbl 0x8800,%eax
    2634:	d1 fa                	sar    %edx
    2636:	39 d0                	cmp    %edx,%eax
    2638:	75 6e                	jne    26a8 <bigfile+0x138>
    263a:	0f be 15 2b 89 00 00 	movsbl 0x892b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2656:	68 00 88 00 00       	push   $0x8800
    265b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    2685:	68 0c 4a 00 00       	push   $0x4a0c
    268a:	e8 44 13 00 00       	call   39d3 <unlink>
  printf(1, "bigfile test ok\n");
    268f:	58                   	pop    %eax
    2690:	5a                   	pop    %edx
    2691:	68 9b 4a 00 00       	push   $0x4a9b
    2696:	6a 01                	push   $0x1
    ...
    26ab:	68 68 4a 00 00       	push   $0x4a68
    26b0:	6a 01                	push   $0x1
    ...
    26bf:	68 54 4a 00 00       	push   $0x4a54
    26c4:	6a 01                	push   $0x1
    ...
    26d3:	68 3f 4a 00 00       	push   $0x4a3f
    26d8:	6a 01                	push   $0x1
    ...
    26e7:	68 14 4a 00 00       	push   $0x4a14
    26ec:	6a 01                	push   $0x1
    ...
    26f8:	53                   	push   %ebx
    26f9:	53                   	push   %ebx
    26fa:	68 2a 4a 00 00       	push   $0x4a2a
    26ff:	6a 01                	push   $0x1
    ...
    270b:	50                   	push   %eax
    270c:	50                   	push   %eax
    270d:	68 fe 49 00 00       	push   $0x49fe
    2712:	6a 01                	push   $0x1
    ...
    271e:	51                   	push   %ecx
    271f:	51                   	push   %ecx
    2720:	68 81 4a 00 00       	push   $0x4a81
    2725:	6a 01                	push   $0x1
...
00002740 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    274a:	68 ac 4a 00 00       	push   $0x4aac
    274f:	6a 01                	push   $0x1
    2751:	e8 ea 13 00 00       	call   3b40 <printf>
  if(mkdir("12345678901234") != 0){
    2756:	c7 04 24 e7 4a 00 00 	movl   $0x4ae7,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2770:	68 a4 52 00 00       	push   $0x52a4
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    278d:	68 f4 52 00 00       	push   $0x52f4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 64 53 00 00       	push   $0x5364
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 d8 4a 00 00 	movl   $0x4ad8,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27df:	68 00 54 00 00       	push   $0x5400
  ...
  printf(1, "fourteen ok\n");
    ...
    27f3:	68 f6 4a 00 00       	push   $0x4af6
    27f8:	6a 01                	push   $0x1
    ...
    2804:	50                   	push   %eax
    2805:	50                   	push   %eax
    2806:	68 bb 4a 00 00       	push   $0x4abb
    280b:	6a 01                	push   $0x1
    ...
    2817:	50                   	push   %eax
    2818:	50                   	push   %eax
    2819:	68 20 54 00 00       	push   $0x5420
    281e:	6a 01                	push   $0x1
    ...
    282a:	52                   	push   %edx
    282b:	52                   	push   %edx
    282c:	68 d0 53 00 00       	push   $0x53d0
    2831:	6a 01                	push   $0x1
    ...
    283d:	51                   	push   %ecx
    283e:	51                   	push   %ecx
    283f:	68 94 53 00 00       	push   $0x5394
    2844:	6a 01                	push   $0x1
    ...
    2850:	51                   	push   %ecx
    2851:	51                   	push   %ecx
    2852:	68 24 53 00 00       	push   $0x5324
    2857:	6a 01                	push   $0x1
    ...
    2863:	50                   	push   %eax
    2864:	50                   	push   %eax
    2865:	68 c4 52 00 00       	push   $0x52c4
    286a:	6a 01                	push   $0x1
...
00002880 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    288a:	68 03 4b 00 00       	push   $0x4b03
    288f:	6a 01                	push   $0x1
    2891:	e8 aa 12 00 00       	call   3b40 <printf>
  if(mkdir("dots") != 0){
    2896:	c7 04 24 0f 4b 00 00 	movl   $0x4b0f,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    28b0:	68 0f 4b 00 00       	push   $0x4b0f
  ...
  if(unlink(".") == 0){
    ...
    28c8:	68 ba 47 00 00       	push   $0x47ba
  ...
  if(unlink("..") == 0){
    ...
    28e0:	68 b9 47 00 00       	push   $0x47b9
  ...
  if(chdir("/") != 0){
    ...
    28f8:	68 8d 3f 00 00       	push   $0x3f8d
  ...
  if(unlink("dots/.") == 0){
    ...
    2910:	68 57 4b 00 00       	push   $0x4b57
  ...
  if(unlink("dots/..") == 0){
    ...
    2924:	68 75 4b 00 00       	push   $0x4b75
  ...
  if(unlink("dots") != 0){
    ...
    2938:	68 0f 4b 00 00       	push   $0x4b0f
  ...
  printf(1, "rmdot ok\n");
    ...
    294c:	68 aa 4b 00 00       	push   $0x4baa
    2951:	6a 01                	push   $0x1
    ...
    295d:	50                   	push   %eax
    295e:	50                   	push   %eax
    295f:	68 14 4b 00 00       	push   $0x4b14
    2964:	6a 01                	push   $0x1
    ...
    2970:	50                   	push   %eax
    2971:	50                   	push   %eax
    2972:	68 95 4b 00 00       	push   $0x4b95
    2977:	6a 01                	push   $0x1
    ...
    2983:	52                   	push   %edx
    2984:	52                   	push   %edx
    2985:	68 7d 4b 00 00       	push   $0x4b7d
    298a:	6a 01                	push   $0x1
    ...
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    2998:	68 5e 4b 00 00       	push   $0x4b5e
    299d:	6a 01                	push   $0x1
    ...
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    29ab:	68 8f 3f 00 00       	push   $0x3f8f
    29b0:	6a 01                	push   $0x1
    ...
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    29be:	68 48 4b 00 00       	push   $0x4b48
    29c3:	6a 01                	push   $0x1
    ...
    29cf:	50                   	push   %eax
    29d0:	50                   	push   %eax
    29d1:	68 3a 4b 00 00       	push   $0x4b3a
    29d6:	6a 01                	push   $0x1
    ...
    29e2:	50                   	push   %eax
    29e3:	50                   	push   %eax
    29e4:	68 27 4b 00 00       	push   $0x4b27
    29e9:	6a 01                	push   $0x1
...
00002a00 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2a0b:	68 b4 4b 00 00       	push   $0x4bb4
    2a10:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a1e:	68 c1 4b 00 00       	push   $0x4bc1
  ...
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 c1 4b 00 00 	movl   $0x4bc1,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a56:	6a 00                	push   $0x0
    2a58:	68 fa 4b 00 00       	push   $0x4bfa
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a75:	68 fa 4b 00 00       	push   $0x4bfa
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a8d:	68 fa 4b 00 00       	push   $0x4bfa
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aa5:	68 fa 4b 00 00       	push   $0x4bfa
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2abd:	68 fa 4b 00 00       	push   $0x4bfa
    2ac2:	68 5e 4c 00 00       	push   $0x4c5e
  ...
  if(unlink("dirfile") != 0){
    ...
    2ada:	68 c1 4b 00 00       	push   $0x4bc1
  ...
  fd = open(".", O_RDWR);
    ...
    2af2:	6a 02                	push   $0x2
    2af4:	68 ba 47 00 00       	push   $0x47ba
  ...
  fd = open(".", 0);
    ...
    2b0c:	6a 00                	push   $0x0
    2b0e:	68 ba 47 00 00       	push   $0x47ba
  ...
  if(write(fd, "x", 1) > 0){
    2b1f:	68 9d 48 00 00       	push   $0x489d
    2b24:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2b3a:	58                   	pop    %eax
    2b3b:	5a                   	pop    %edx
    2b3c:	68 91 4c 00 00       	push   $0x4c91
    2b41:	6a 01                	push   $0x1
    ...
    2b50:	50                   	push   %eax
    2b51:	50                   	push   %eax
    2b52:	68 05 4c 00 00       	push   $0x4c05
    2b57:	6a 01                	push   $0x1
    ...
    2b63:	52                   	push   %edx
    2b64:	52                   	push   %edx
    2b65:	68 e0 4b 00 00       	push   $0x4be0
    2b6a:	6a 01                	push   $0x1
    ...
    2b76:	51                   	push   %ecx
    2b77:	51                   	push   %ecx
    2b78:	68 c9 4b 00 00       	push   $0x4bc9
    2b7d:	6a 01                	push   $0x1
    ...
    2b89:	51                   	push   %ecx
    2b8a:	51                   	push   %ecx
    2b8b:	68 7d 4c 00 00       	push   $0x4c7d
    2b90:	6a 01                	push   $0x1
    ...
    2b9c:	53                   	push   %ebx
    2b9d:	53                   	push   %ebx
    2b9e:	68 74 54 00 00       	push   $0x5474
    2ba3:	6a 01                	push   $0x1
    ...
    2baf:	50                   	push   %eax
    2bb0:	50                   	push   %eax
    2bb1:	68 65 4c 00 00       	push   $0x4c65
    2bb6:	6a 01                	push   $0x1
    ...
    2bc2:	50                   	push   %eax
    2bc3:	50                   	push   %eax
    2bc4:	68 54 54 00 00       	push   $0x5454
    2bc9:	6a 01                	push   $0x1
    ...
    2bd5:	50                   	push   %eax
    2bd6:	50                   	push   %eax
    2bd7:	68 40 4c 00 00       	push   $0x4c40
    2bdc:	6a 01                	push   $0x1
    ...
    2be8:	50                   	push   %eax
    2be9:	50                   	push   %eax
    2bea:	68 23 4c 00 00       	push   $0x4c23
    2bef:	6a 01                	push   $0x1
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2c10:	68 a1 4c 00 00       	push   $0x4ca1
    2c15:	6a 01                	push   $0x1
    ...
    2c23:	68 b2 4c 00 00       	push   $0x4cb2
    ...
    2c3b:	68 b2 4c 00 00       	push   $0x4cb2
    ...
    2c53:	68 0e 57 00 00       	push   $0x570e
    2c58:	e8 8e 0d 00 00       	call   39eb <mkdir>
    link("README", "");
    2c5d:	59                   	pop    %ecx
    2c5e:	58                   	pop    %eax
    2c5f:	68 0e 57 00 00       	push   $0x570e
    2c64:	68 5e 4c 00 00       	push   $0x4c5e
    2c69:	e8 75 0d 00 00       	call   39e3 <link>
    fd = open("", O_CREATE);
    2c6e:	58                   	pop    %eax
    2c6f:	5a                   	pop    %edx
    2c70:	68 00 02 00 00       	push   $0x200
    2c75:	68 0e 57 00 00       	push   $0x570e
    ...
    2c9a:	68 9c 48 00 00       	push   $0x489c
    ...
    2cba:	68 9c 48 00 00       	push   $0x489c
  ...
  chdir("/");
    ...
    2cd3:	68 8d 3f 00 00       	push   $0x3f8d
    2cd8:	e8 16 0d 00 00       	call   39f3 <chdir>
  printf(1, "empty file name OK\n");
    2cdd:	58                   	pop    %eax
    2cde:	5a                   	pop    %edx
    2cdf:	68 e0 4c 00 00       	push   $0x4ce0
    2ce4:	6a 01                	push   $0x1
    ...
    2cf6:	68 b8 4c 00 00       	push   $0x4cb8
    2cfb:	6a 01                	push   $0x1
    ...
    2d0a:	68 cc 4c 00 00       	push   $0x4ccc
    2d0f:	6a 01                	push   $0x1
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2d2d:	68 f4 4c 00 00       	push   $0x4cf4
    2d32:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2d7b:	68 26 4d 00 00       	push   $0x4d26
    2d80:	6a 01                	push   $0x1
    ...
    2d94:	68 ff 4c 00 00       	push   $0x4cff
    2d99:	6a 01                	push   $0x1
    ...
    2da5:	52                   	push   %edx
    2da6:	52                   	push   %edx
    2da7:	68 13 4d 00 00       	push   $0x4d13
    2dac:	6a 01                	push   $0x1
    ...
    2db8:	50                   	push   %eax
    2db9:	50                   	push   %eax
    2dba:	68 94 54 00 00       	push   $0x5494
    2dbf:	6a 01                	push   $0x1
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2ddf:	68 34 4d 00 00       	push   $0x4d34
    2de4:	ff 35 24 60 00 00    	pushl  0x6024
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3034:	68 dc 4d 00 00       	push   $0x4ddc
    3039:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    306d:	6a 01                	push   $0x1
    306f:	68 9d 48 00 00       	push   $0x489d
    ...
    30af:	56                   	push   %esi
    30b0:	57                   	push   %edi
    30b1:	68 3f 4d 00 00       	push   $0x4d3f
    30b6:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    30c9:	50                   	push   %eax
    30ca:	50                   	push   %eax
    30cb:	68 c1 4d 00 00       	push   $0x4dc1
    30d0:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    30e0:	52                   	push   %edx
    30e1:	52                   	push   %edx
    30e2:	68 7d 42 00 00       	push   $0x427d
    30e7:	6a 01                	push   $0x1
    ...
    30fb:	50                   	push   %eax
    30fc:	56                   	push   %esi
    30fd:	68 a8 4d 00 00       	push   $0x4da8
    3102:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    311d:	68 85 4e 00 00       	push   $0x4e85
    3122:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3132:	50                   	push   %eax
    3133:	56                   	push   %esi
    3134:	68 88 55 00 00       	push   $0x5588
    3139:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3149:	51                   	push   %ecx
    314a:	51                   	push   %ecx
    314b:	68 58 55 00 00       	push   $0x5558
    3150:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3160:	57                   	push   %edi
    3161:	56                   	push   %esi
    3162:	68 30 55 00 00       	push   $0x5530
    3167:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3177:	50                   	push   %eax
    3178:	56                   	push   %esi
    3179:	68 f8 54 00 00       	push   $0x54f8
    317e:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    318e:	53                   	push   %ebx
    318f:	53                   	push   %ebx
    3190:	68 8d 4d 00 00       	push   $0x4d8d
    3195:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    31a5:	56                   	push   %esi
    31a6:	56                   	push   %esi
    31a7:	68 b8 54 00 00       	push   $0x54b8
    31ac:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    31c1:	57                   	push   %edi
    31c2:	57                   	push   %edi
    31c3:	68 71 4d 00 00       	push   $0x4d71
    31c8:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    31d8:	50                   	push   %eax
    31d9:	50                   	push   %eax
    31da:	68 5a 4d 00 00       	push   $0x4d5a
    31df:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    320e:	68 ea 4d 00 00       	push   $0x4dea
    3213:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3257:	5a                   	pop    %edx
    3258:	56                   	push   %esi
    3259:	68 f9 4d 00 00       	push   $0x4df9
  ...
  printf(stdout, "validate ok\n");
    ...
    327c:	68 1d 4e 00 00       	push   $0x4e1d
    3281:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    329e:	68 04 4e 00 00       	push   $0x4e04
    32a3:	ff 35 24 60 00 00    	pushl  0x6024
...
000032c0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32ca:	68 2a 4e 00 00       	push   $0x4e2a
    32cf:	ff 35 24 60 00 00    	pushl  0x6024
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    32df:	90                   	nop
    if(uninit[i] != '\0'){
    32e0:	80 b8 e0 60 00 00 00 	cmpb   $0x0,0x60e0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    32f6:	68 45 4e 00 00       	push   $0x4e45
    32fb:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    330e:	68 34 4e 00 00       	push   $0x4e34
    3313:	ff 35 24 60 00 00    	pushl  0x6024
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    333a:	68 52 4e 00 00       	push   $0x4e52
  ...
  fd = open("bigarg-ok", 0);
    ...
    335e:	6a 00                	push   $0x0
    3360:	68 52 4e 00 00       	push   $0x4e52
  ...
  unlink("bigarg-ok");
    337e:	c7 04 24 52 4e 00 00 	movl   $0x4e52,(%esp)
    ...
    3390:	c7 04 85 40 60 00 00 	movl   $0x55ac,0x6040(,%eax,4)
    3397:	ac 55 00 00 
    ...
    33a3:	51                   	push   %ecx
    33a4:	51                   	push   %ecx
    33a5:	68 5c 4e 00 00       	push   $0x4e5c
    33aa:	ff 35 24 60 00 00    	pushl  0x6024
    args[MAXARG-1] = 0;
    33b0:	c7 05 bc 60 00 00 00 	movl   $0x0,0x60bc
    33b7:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    33bf:	58                   	pop    %eax
    33c0:	5a                   	pop    %edx
    33c1:	68 40 60 00 00       	push   $0x6040
    33c6:	68 29 40 00 00       	push   $0x4029
    33cb:	e8 eb 05 00 00       	call   39bb <exec>
    printf(stdout, "bigarg test ok\n");
    33d0:	59                   	pop    %ecx
    33d1:	58                   	pop    %eax
    33d2:	68 69 4e 00 00       	push   $0x4e69
    33d7:	ff 35 24 60 00 00    	pushl  0x6024
    33dd:	e8 5e 07 00 00       	call   3b40 <printf>
    fd = open("bigarg-ok", O_CREATE);
    33e2:	58                   	pop    %eax
    33e3:	5a                   	pop    %edx
    33e4:	68 00 02 00 00       	push   $0x200
    33e9:	68 52 4e 00 00       	push   $0x4e52
    ...
    3400:	50                   	push   %eax
    3401:	50                   	push   %eax
    3402:	68 92 4e 00 00       	push   $0x4e92
    3407:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3417:	52                   	push   %edx
    3418:	52                   	push   %edx
    3419:	68 79 4e 00 00       	push   $0x4e79
    341e:	ff 35 24 60 00 00    	pushl  0x6024
    ...
    3439:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    343f:	68 a7 4e 00 00       	push   $0x4ea7
    3444:	6a 01                	push   $0x1
    ...
    34c3:	50                   	push   %eax
    34c4:	68 b4 4e 00 00       	push   $0x4eb4
    34c9:	6a 01                	push   $0x1
    ...
    34fa:	68 00 88 00 00       	push   $0x8800
    34ff:	57                   	push   %edi
    ...
    3512:	53                   	push   %ebx
    3513:	68 d0 4e 00 00       	push   $0x4ed0
    3518:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    353c:	50                   	push   %eax
    353d:	68 c0 4e 00 00       	push   $0x4ec0
    3542:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    35ee:	68 e0 4e 00 00       	push   $0x4ee0
    35f3:	6a 01                	push   $0x1
...
00003610 <uio>:
{
  ...
  printf(1, "uio test\n");
    361a:	68 f6 4e 00 00       	push   $0x4ef6
    361f:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    363c:	68 00 4f 00 00       	push   $0x4f00
    3641:	6a 01                	push   $0x1
    ...
    365e:	52                   	push   %edx
    365f:	52                   	push   %edx
    3660:	68 8c 56 00 00       	push   $0x568c
    3665:	6a 01                	push   $0x1
    ...
    3671:	50                   	push   %eax
    3672:	50                   	push   %eax
    3673:	68 85 4e 00 00       	push   $0x4e85
    3678:	6a 01                	push   $0x1
...
00003690 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    369b:	6a 00                	push   $0x0
    369d:	68 0f 4f 00 00       	push   $0x4f0f
  ...
  printf(1, "arg test passed\n");
    36d1:	58                   	pop    %eax
    36d2:	5a                   	pop    %edx
    36d3:	68 21 4f 00 00       	push   $0x4f21
    36d8:	6a 01                	push   $0x1
    ...
    36e7:	51                   	push   %ecx
    36e8:	51                   	push   %ecx
    36e9:	68 14 4f 00 00       	push   $0x4f14
    36ee:	6a 02                	push   $0x2
...
00003700 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3704:	69 05 20 60 00 00 0d 	imul   $0x19660d,0x6020,%eax
    370b:	66 19 00 
    370e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3713:	a3 20 60 00 00       	mov    %eax,0x6020
}
    3718:	c3                   	ret    
    ...
    3a9c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3ac9:	0f b6 92 e4 56 00 00 	movzbl 0x56e4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3cc4:	eb 1a                	jmp    3ce0 <printf+0x1a0>
          s = "(null)";
    3cc6:	bb da 56 00 00       	mov    $0x56da,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d15:	a1 c0 60 00 00       	mov    0x60c0,%eax
{
    ...
    3d36:	73 10                	jae    3d48 <free+0x38>
{
  ...
  freep = p;
    ...
    3d61:	5b                   	pop    %ebx
  freep = p;
    3d62:	a3 c0 60 00 00       	mov    %eax,0x60c0
}
    3d67:	5e                   	pop    %esi
    3d68:	5f                   	pop    %edi
    3d69:	5d                   	pop    %ebp
  ...
  freep = p;
    3d8a:	a3 c0 60 00 00       	mov    %eax,0x60c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3db0:	8b 3d c0 60 00 00    	mov    0x60c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3df9:	8b 3d c0 60 00 00    	mov    0x60c0,%edi
  ...
  return freep;
    3e27:	a1 c0 60 00 00       	mov    0x60c0,%eax
    ...
    3e54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3e57:	a3 c0 60 00 00       	mov    %eax,0x60c0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e70:	c7 05 c0 60 00 00 c4 	movl   $0x60c4,0x60c0
    3e77:	60 00 00 
    base.s.size = 0;
    3e7a:	bf c4 60 00 00       	mov    $0x60c4,%edi
    base.s.ptr = freep = prevp = &base;
    3e7f:	c7 05 c4 60 00 00 c4 	movl   $0x60c4,0x60c4
    3e86:	60 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e8b:	c7 05 c8 60 00 00 00 	movl   $0x0,0x60c8
    3e92:	00 00 00 
    if(p->s.size >= nunits){
    ...
    3ea6:	66 90                	xchg   %ax,%ax
    3ea8:	66 90                	xchg   %ax,%ax
    3eaa:	66 90                	xchg   %ax,%ax
    3eac:	66 90                	xchg   %ax,%ax
    3eae:	66 90                	xchg   %ax,%ax

00003eb0 <thread_creator>:
#include "stat.h"
#include "user.h"
...
int thread_creator (void (*fn) (void *), void *args) {
    ...
    3ebb:	68 00 20 00 00       	push   $0x2000
    3ec0:	e8 db fe ff ff       	call   3da0 <malloc>
    void *stack;

    if (fptr == 0)
    3ec5:	83 c4 10             	add    $0x10,%esp
    3ec8:	85 c0                	test   %eax,%eax
    3eca:	74 59                	je     3f25 <thread_creator+0x75>
    3ecc:	89 c3                	mov    %eax,%ebx
        return -1;
    
    int mod = (uint)fptr % PAGESIZE;

    if (mod == 0)
    3ece:	25 ff 0f 00 00       	and    $0xfff,%eax
    3ed3:	75 1b                	jne    3ef0 <thread_creator+0x40>
        stack = fptr;
    else
    ...
    3ed8:	53                   	push   %ebx
    3ed9:	e8 5d fb ff ff       	call   3a3b <thread_create>

    if (thread_id < 0)
    3ede:	83 c4 10             	add    $0x10,%esp
    3ee1:	85 c0                	test   %eax,%eax
    3ee3:	78 23                	js     3f08 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
    3ee5:	74 45                	je     3f2c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
    ...
    3ee7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3eea:	c9                   	leave  
    3eeb:	c3                   	ret    
    3eec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        stack = fptr + (PAGESIZE - mod);
    3ef0:	29 c3                	sub    %eax,%ebx
    int thread_id = thread_create((void*)stack);
    3ef2:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
    3ef5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
    3efb:	53                   	push   %ebx
    3efc:	e8 3a fb ff ff       	call   3a3b <thread_create>
    if (thread_id < 0)
    3f01:	83 c4 10             	add    $0x10,%esp
    3f04:	85 c0                	test   %eax,%eax
    3f06:	79 dd                	jns    3ee5 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
    3f08:	83 ec 08             	sub    $0x8,%esp
    3f0b:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3f0e:	68 f5 56 00 00       	push   $0x56f5
    3f13:	6a 01                	push   $0x1
    3f15:	e8 26 fc ff ff       	call   3b40 <printf>
    3f1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
    3f1d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3f20:	83 c4 10             	add    $0x10,%esp
    3f23:	c9                   	leave  
    3f24:	c3                   	ret    
        return -1;
    3f25:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3f2a:	eb bb                	jmp    3ee7 <thread_creator+0x37>
        (fn)(args);
    3f2c:	83 ec 0c             	sub    $0xc,%esp
    3f2f:	ff 75 0c             	pushl  0xc(%ebp)
    3f32:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
    3f35:	89 1c 24             	mov    %ebx,(%esp)
    3f38:	e8 d3 fd ff ff       	call   3d10 <free>
        exit();
    3f3d:	e8 41 fa ff ff       	call   3983 <exit>
