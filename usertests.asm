...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     12a:	68 b8 3f 00 00       	push   $0x3fb8
     12f:	ff 35 04 60 00 00    	pushl  0x6004
     135:	e8 e6 39 00 00       	call   3b20 <printf>
  if(mkdir("iputdir") < 0){
     13a:	c7 04 24 4b 3f 00 00 	movl   $0x3f4b,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     150:	68 4b 3f 00 00       	push   $0x3f4b
  ...
  if(unlink("../iputdir") < 0){
     ...
     168:	68 48 3f 00 00       	push   $0x3f48
  ...
  if(chdir("/") < 0){
     ...
     17c:	68 6d 3f 00 00       	push   $0x3f6d
  ...
  printf(stdout, "iput test ok\n");
     ...
     190:	68 f0 3f 00 00       	push   $0x3ff0
     195:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "mkdir failed\n");
     1a5:	50                   	push   %eax
     1a6:	50                   	push   %eax
     1a7:	68 24 3f 00 00       	push   $0x3f24
     1ac:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "chdir / failed\n");
     1bc:	50                   	push   %eax
     1bd:	50                   	push   %eax
     1be:	68 6f 3f 00 00       	push   $0x3f6f
     1c3:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1d3:	52                   	push   %edx
     1d4:	52                   	push   %edx
     1d5:	68 53 3f 00 00       	push   $0x3f53
     1da:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "chdir iputdir failed\n");
     1ea:	51                   	push   %ecx
     1eb:	51                   	push   %ecx
     1ec:	68 32 3f 00 00       	push   $0x3f32
     1f1:	ff 35 04 60 00 00    	pushl  0x6004
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     21a:	68 7f 3f 00 00       	push   $0x3f7f
     21f:	ff 35 04 60 00 00    	pushl  0x6004
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     23f:	68 4b 3f 00 00       	push   $0x3f4b
    ...
    if(chdir("iputdir") < 0){
     ...
     257:	68 4b 3f 00 00       	push   $0x3f4b
    ...
    if(unlink("../iputdir") < 0){
     ...
     26f:	68 48 3f 00 00       	push   $0x3f48
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     290:	68 a2 3f 00 00       	push   $0x3fa2
     295:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     2ab:	68 53 3f 00 00       	push   $0x3f53
     2b0:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "fork failed\n");
     2c0:	51                   	push   %ecx
     2c1:	51                   	push   %ecx
     2c2:	68 65 4e 00 00       	push   $0x4e65
     2c7:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    exit();
     ...
     2d7:	52                   	push   %edx
     2d8:	52                   	push   %edx
     2d9:	68 24 3f 00 00       	push   $0x3f24
     2de:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     2ee:	50                   	push   %eax
     2ef:	50                   	push   %eax
     2f0:	68 8e 3f 00 00       	push   $0x3f8e
     2f5:	ff 35 04 60 00 00    	pushl  0x6004
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     31a:	68 b4 3f 00 00       	push   $0x3fb4
     31f:	ff 35 04 60 00 00    	pushl  0x6004
     325:	e8 f6 37 00 00       	call   3b20 <printf>
  if(mkdir("oidir") < 0){
     32a:	c7 04 24 c3 3f 00 00 	movl   $0x3fc3,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     34f:	6a 02                	push   $0x2
     351:	68 c3 3f 00 00       	push   $0x3fc3
    ...
    if(fd >= 0){
     ...
     365:	68 48 4f 00 00       	push   $0x4f48
     36a:	ff 35 04 60 00 00    	pushl  0x6004
  ...
  if(unlink("oidir") != 0){
     38a:	c7 04 24 c3 3f 00 00 	movl   $0x3fc3,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3a5:	68 ec 3f 00 00       	push   $0x3fec
     3aa:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "fork failed\n");
     3c5:	52                   	push   %edx
     3c6:	52                   	push   %edx
     3c7:	68 65 4e 00 00       	push   $0x4e65
     3cc:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "mkdir oidir failed\n");
     3dc:	51                   	push   %ecx
     3dd:	51                   	push   %ecx
     3de:	68 c9 3f 00 00       	push   $0x3fc9
     3e3:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "unlink failed\n");
     3f3:	50                   	push   %eax
     3f4:	50                   	push   %eax
     3f5:	68 dd 3f 00 00       	push   $0x3fdd
     3fa:	ff 35 04 60 00 00    	pushl  0x6004
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     41a:	68 fe 3f 00 00       	push   $0x3ffe
     41f:	ff 35 04 60 00 00    	pushl  0x6004
     425:	e8 f6 36 00 00       	call   3b20 <printf>
  fd = open("echo", 0);
     42a:	58                   	pop    %eax
     42b:	5a                   	pop    %edx
     42c:	6a 00                	push   $0x0
     42e:	68 09 40 00 00       	push   $0x4009
  ...
  fd = open("doesnotexist", 0);
     ...
     449:	59                   	pop    %ecx
     44a:	6a 00                	push   $0x0
     44c:	68 21 40 00 00       	push   $0x4021
  ...
  printf(stdout, "open test ok\n");
     ...
     460:	68 4c 40 00 00       	push   $0x404c
     465:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "open echo failed!\n");
     475:	50                   	push   %eax
     476:	50                   	push   %eax
     477:	68 0e 40 00 00       	push   $0x400e
     47c:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     48c:	50                   	push   %eax
     48d:	50                   	push   %eax
     48e:	68 2e 40 00 00       	push   $0x402e
     493:	ff 35 04 60 00 00    	pushl  0x6004
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4bc:	68 5a 40 00 00       	push   $0x405a
     4c1:	ff 35 04 60 00 00    	pushl  0x6004
     4c7:	e8 54 36 00 00       	call   3b20 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4cc:	58                   	pop    %eax
     4cd:	5a                   	pop    %edx
     4ce:	68 02 02 00 00       	push   $0x202
     4d3:	68 6b 40 00 00       	push   $0x406b
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4ef:	68 71 40 00 00       	push   $0x4071
     4f4:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     50b:	6a 0a                	push   $0xa
     50d:	68 a8 40 00 00       	push   $0x40a8
     512:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     527:	6a 0a                	push   $0xa
     529:	68 b3 40 00 00       	push   $0x40b3
     52e:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     54b:	68 be 40 00 00       	push   $0x40be
     550:	ff 35 04 60 00 00    	pushl  0x6004
  ...
  fd = open("small", O_RDONLY);
     ...
     564:	5e                   	pop    %esi
     565:	6a 00                	push   $0x0
     567:	68 6b 40 00 00       	push   $0x406b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     581:	68 c9 40 00 00       	push   $0x40c9
     586:	ff 35 04 60 00 00    	pushl  0x6004
     58c:	e8 8f 35 00 00       	call   3b20 <printf>
  i = read(fd, buf, 2000);
     591:	83 c4 0c             	add    $0xc,%esp
     594:	68 d0 07 00 00       	push   $0x7d0
     599:	68 e0 87 00 00       	push   $0x87e0
     59e:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5b5:	68 fd 40 00 00       	push   $0x40fd
     5ba:	ff 35 04 60 00 00    	pushl  0x6004
     5c0:	e8 5b 35 00 00       	call   3b20 <printf>
  close(fd);
     5c5:	89 1c 24             	mov    %ebx,(%esp)
     5c8:	e8 de 33 00 00       	call   39ab <close>
  if(unlink("small") < 0){
     5cd:	c7 04 24 6b 40 00 00 	movl   $0x406b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e3:	68 25 41 00 00       	push   $0x4125
     5e8:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     600:	53                   	push   %ebx
     601:	68 6c 4f 00 00       	push   $0x4f6c
     606:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     619:	53                   	push   %ebx
     61a:	68 90 4f 00 00       	push   $0x4f90
     61f:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "error: open small failed!\n");
     62f:	51                   	push   %ecx
     630:	51                   	push   %ecx
     631:	68 e2 40 00 00       	push   $0x40e2
     636:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "read failed\n");
     646:	52                   	push   %edx
     647:	52                   	push   %edx
     648:	68 29 44 00 00       	push   $0x4429
     64d:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "unlink small failed\n");
     65d:	50                   	push   %eax
     65e:	50                   	push   %eax
     65f:	68 10 41 00 00       	push   $0x4110
     664:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "error: creat small failed!\n");
     674:	50                   	push   %eax
     675:	50                   	push   %eax
     676:	68 8c 40 00 00       	push   $0x408c
     67b:	ff 35 04 60 00 00    	pushl  0x6004
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     69c:	68 39 41 00 00       	push   $0x4139
     6a1:	ff 35 04 60 00 00    	pushl  0x6004
     6a7:	e8 74 34 00 00       	call   3b20 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     6ac:	58                   	pop    %eax
     6ad:	5a                   	pop    %edx
     6ae:	68 02 02 00 00       	push   $0x202
     6b3:	68 b3 41 00 00       	push   $0x41b3
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6d3:	89 1d e0 87 00 00    	mov    %ebx,0x87e0
    if(write(fd, buf, 512) != 512){
     6d9:	68 00 02 00 00       	push   $0x200
     6de:	68 e0 87 00 00       	push   $0x87e0
     6e3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     70c:	5e                   	pop    %esi
     70d:	6a 00                	push   $0x0
     70f:	68 b3 41 00 00       	push   $0x41b3
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     73b:	a1 e0 87 00 00       	mov    0x87e0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     74f:	68 e0 87 00 00       	push   $0x87e0
     754:	53                   	push   %ebx
  ...
  if(unlink("big") < 0){
     776:	c7 04 24 b3 41 00 00 	movl   $0x41b3,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     790:	68 da 41 00 00       	push   $0x41da
     795:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     7ad:	53                   	push   %ebx
     7ae:	68 63 41 00 00       	push   $0x4163
     7b3:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     7c3:	50                   	push   %eax
     7c4:	56                   	push   %esi
     7c5:	68 b4 4f 00 00       	push   $0x4fb4
     7ca:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     7dd:	50                   	push   %eax
     7de:	68 b7 41 00 00       	push   $0x41b7
     7e3:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     7f9:	68 9a 41 00 00       	push   $0x419a
     7fe:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "error: open big failed!\n");
     80e:	51                   	push   %ecx
     80f:	51                   	push   %ecx
     810:	68 81 41 00 00       	push   $0x4181
     815:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "error: creat big failed!\n");
     825:	50                   	push   %eax
     826:	50                   	push   %eax
     827:	68 49 41 00 00       	push   $0x4149
     82c:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "unlink big failed\n");
     83c:	50                   	push   %eax
     83d:	50                   	push   %eax
     83e:	68 c7 41 00 00       	push   $0x41c7
     843:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     870:	68 d4 4f 00 00       	push   $0x4fd4
     875:	ff 35 04 60 00 00    	pushl  0x6004
     87b:	e8 a0 32 00 00       	call   3b20 <printf>
  name[0] = 'a';
     880:	c6 05 e0 a7 00 00 61 	movb   $0x61,0xa7e0
  name[2] = '\0';
     887:	83 c4 10             	add    $0x10,%esp
     88a:	c6 05 e2 a7 00 00 00 	movb   $0x0,0xa7e2
  for(i = 0; i < 52; i++){
     891:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    fd = open(name, O_CREATE|O_RDWR);
     898:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     89b:	88 1d e1 a7 00 00    	mov    %bl,0xa7e1
    fd = open(name, O_CREATE|O_RDWR);
     8a1:	83 c3 01             	add    $0x1,%ebx
     8a4:	68 02 02 00 00       	push   $0x202
     8a9:	68 e0 a7 00 00       	push   $0xa7e0
  ...
  name[0] = 'a';
     8c3:	c6 05 e0 a7 00 00 61 	movb   $0x61,0xa7e0
  name[2] = '\0';
     8ca:	bb 30 00 00 00       	mov    $0x30,%ebx
     8cf:	c6 05 e2 a7 00 00 00 	movb   $0x0,0xa7e2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     8e3:	88 1d e1 a7 00 00    	mov    %bl,0xa7e1
    unlink(name);
     8e9:	83 c3 01             	add    $0x1,%ebx
     8ec:	68 e0 a7 00 00       	push   $0xa7e0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     901:	68 fc 4f 00 00       	push   $0x4ffc
     906:	ff 35 04 60 00 00    	pushl  0x6004
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     92a:	68 e8 41 00 00       	push   $0x41e8
     92f:	ff 35 04 60 00 00    	pushl  0x6004
     935:	e8 e6 31 00 00       	call   3b20 <printf>
  if(mkdir("dir0") < 0){
     93a:	c7 04 24 f4 41 00 00 	movl   $0x41f4,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     950:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(chdir("..") < 0){
     ...
     968:	68 99 47 00 00       	push   $0x4799
  ...
  if(unlink("dir0") < 0){
     ...
     97c:	68 f4 41 00 00       	push   $0x41f4
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     990:	68 31 42 00 00       	push   $0x4231
     995:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "mkdir failed\n");
     9a5:	50                   	push   %eax
     9a6:	50                   	push   %eax
     9a7:	68 24 3f 00 00       	push   $0x3f24
     9ac:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "unlink dir0 failed\n");
     9bc:	50                   	push   %eax
     9bd:	50                   	push   %eax
     9be:	68 1d 42 00 00       	push   $0x421d
     9c3:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "chdir .. failed\n");
     9d3:	52                   	push   %edx
     9d4:	52                   	push   %edx
     9d5:	68 0c 42 00 00       	push   $0x420c
     9da:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    printf(stdout, "chdir dir0 failed\n");
     9ea:	51                   	push   %ecx
     9eb:	51                   	push   %ecx
     9ec:	68 f9 41 00 00       	push   $0x41f9
     9f1:	ff 35 04 60 00 00    	pushl  0x6004
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a1a:	68 40 42 00 00       	push   $0x4240
     a1f:	ff 35 04 60 00 00    	pushl  0x6004
     a25:	e8 f6 30 00 00       	call   3b20 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 08 60 00 00       	push   $0x6008
     a31:	68 09 40 00 00       	push   $0x4009
    ...
    printf(stdout, "exec echo failed\n");
     a44:	50                   	push   %eax
     a45:	50                   	push   %eax
     a46:	68 4b 42 00 00       	push   $0x424b
     a4b:	ff 35 04 60 00 00    	pushl  0x6004
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ab3:	56                   	push   %esi
     ab4:	68 e0 87 00 00       	push   $0x87e0
     ...
     add:	38 90 e0 87 00 00    	cmp    %dl,0x87e0(%eax)
     ...
     b04:	68 7a 42 00 00       	push   $0x427a
     b09:	6a 01                	push   $0x1
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     b33:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     b36:	88 90 df 87 00 00    	mov    %dl,0x87df(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b51:	68 e0 87 00 00       	push   $0x87e0
  ...
  printf(1, "pipe1 ok\n");
     b8e:	5a                   	pop    %edx
     b8f:	59                   	pop    %ecx
     b90:	68 9f 42 00 00       	push   $0x429f
     b95:	6a 01                	push   $0x1
     ...
     ba8:	68 88 42 00 00       	push   $0x4288
     bad:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     bb9:	57                   	push   %edi
     bba:	57                   	push   %edi
     bbb:	68 5d 42 00 00       	push   $0x425d
     bc0:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     bcc:	50                   	push   %eax
     bcd:	50                   	push   %eax
     bce:	68 a9 42 00 00       	push   $0x42a9
     bd3:	6a 01                	push   $0x1
    ...
    exit();
     ...
     bdf:	56                   	push   %esi
     be0:	56                   	push   %esi
     be1:	68 6c 42 00 00       	push   $0x426c
     be6:	6a 01                	push   $0x1
...
00000c00 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c0d:	68 b8 42 00 00       	push   $0x42b8
     c12:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c68:	6a 01                	push   $0x1
     c6a:	68 7d 48 00 00       	push   $0x487d
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     cab:	68 e0 87 00 00       	push   $0x87e0
  ...
  printf(1, "kill... ");
     ccb:	58                   	pop    %eax
     ccc:	5a                   	pop    %edx
     ccd:	68 e9 42 00 00       	push   $0x42e9
     cd2:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     cf1:	59                   	pop    %ecx
     cf2:	5b                   	pop    %ebx
     cf3:	68 f2 42 00 00       	push   $0x42f2
     cf8:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     d0e:	5e                   	pop    %esi
     d0f:	5f                   	pop    %edi
     d10:	68 fb 42 00 00       	push   $0x42fb
     d15:	6a 01                	push   $0x1
     ...
     d2a:	68 c2 42 00 00       	push   $0x42c2
     d2f:	6a 01                	push   $0x1
    ...
    printf(1, "preempt read error");
     ...
     d41:	68 d6 42 00 00       	push   $0x42d6
     d46:	6a 01                	push   $0x1
...
00000d60 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d8e:	68 65 4e 00 00       	push   $0x4e65
     d93:	6a 01                	push   $0x1
     ...
     dab:	68 07 43 00 00       	push   $0x4307
     db0:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     dc4:	68 17 43 00 00       	push   $0x4317
     dc9:	6a 01                	push   $0x1
...
00000de0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     dee:	68 24 43 00 00       	push   $0x4324
     df3:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e69:	58                   	pop    %eax
     e6a:	5a                   	pop    %edx
     e6b:	68 48 43 00 00       	push   $0x4348
     e70:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e83:	68 2e 43 00 00       	push   $0x432e
     e88:	6a 01                	push   $0x1
...
00000eb0 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f3c:	68 50 50 00 00       	push   $0x5050
     f41:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     f6a:	5a                   	pop    %edx
     f6b:	6a 00                	push   $0x0
     f6d:	68 5f 43 00 00       	push   $0x435f
  ...
  unlink("sharedfd");
     fdb:	c7 04 24 5f 43 00 00 	movl   $0x435f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    1000:	68 68 43 00 00       	push   $0x4368
    1005:	6a 01                	push   $0x1
    ...
    101a:	68 24 50 00 00       	push   $0x5024
    101f:	6a 01                	push   $0x1
    ...
    1034:	68 70 50 00 00       	push   $0x5070
    1039:	6a 01                	push   $0x1
    ...
    1050:	53                   	push   %ebx
    1051:	52                   	push   %edx
    1052:	68 75 43 00 00       	push   $0x4375
    1057:	6a 01                	push   $0x1
...
00001070 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1079:	be 8a 43 00 00       	mov    $0x438a,%esi
{
    107e:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1084:	c7 45 d8 8a 43 00 00 	movl   $0x438a,-0x28(%ebp)
  printf(1, "fourfiles test\n");
    108b:	68 90 43 00 00       	push   $0x4390
    1090:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1092:	c7 45 dc d3 44 00 00 	movl   $0x44d3,-0x24(%ebp)
    1099:	c7 45 e0 d7 44 00 00 	movl   $0x44d7,-0x20(%ebp)
    10a0:	c7 45 e4 8d 43 00 00 	movl   $0x438d,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    1118:	68 e0 87 00 00       	push   $0x87e0
    ...
    1133:	0f be ba e0 87 00 00 	movsbl 0x87e0(%edx),%edi
  ...
  printf(1, "fourfiles ok\n");
    ...
    117e:	68 ce 43 00 00       	push   $0x43ce
    1183:	6a 01                	push   $0x1
    ...
    11a2:	68 b1 43 00 00       	push   $0x43b1
    11a7:	6a 01                	push   $0x1
    ...
    11db:	68 e0 87 00 00       	push   $0x87e0
    ...
    11f0:	68 e0 87 00 00       	push   $0x87e0
    11f5:	56                   	push   %esi
    ...
    120f:	51                   	push   %ecx
    1210:	51                   	push   %ecx
    1211:	68 2b 46 00 00       	push   $0x462b
    1216:	6a 01                	push   $0x1
    ...
    122b:	68 65 4e 00 00       	push   $0x4e65
    1230:	6a 01                	push   $0x1
    ...
    123c:	50                   	push   %eax
    123d:	53                   	push   %ebx
    123e:	68 bd 43 00 00       	push   $0x43bd
    1243:	6a 01                	push   $0x1
    ...
    124f:	52                   	push   %edx
    1250:	50                   	push   %eax
    1251:	68 a0 43 00 00       	push   $0x43a0
    1256:	6a 01                	push   $0x1
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    127f:	68 dc 43 00 00       	push   $0x43dc
    1284:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1384:	68 ef 43 00 00       	push   $0x43ef
    1389:	6a 01                	push   $0x1
    ...
    1422:	52                   	push   %edx
    1423:	52                   	push   %edx
    1424:	68 dd 3f 00 00       	push   $0x3fdd
    1429:	6a 01                	push   $0x1
    ...
    1443:	57                   	push   %edi
    1444:	68 9c 50 00 00       	push   $0x509c
    1449:	6a 01                	push   $0x1
    ...
    1458:	68 2b 46 00 00       	push   $0x462b
    145d:	6a 01                	push   $0x1
    ...
    146c:	68 65 4e 00 00       	push   $0x4e65
    1471:	6a 01                	push   $0x1
    ...
    1488:	50                   	push   %eax
    1489:	57                   	push   %edi
    148a:	68 c0 50 00 00       	push   $0x50c0
    148f:	6a 01                	push   $0x1
...
000014a0 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    14ac:	68 00 44 00 00       	push   $0x4400
    14b1:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14bf:	68 11 44 00 00       	push   $0x4411
  ...
  write(fd, "hello", 5);
    ...
    14d9:	6a 05                	push   $0x5
    14db:	68 36 44 00 00       	push   $0x4436
    14e0:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 11 44 00 00       	push   $0x4411
  ...
  if(unlink("unlinkread") != 0){
    ...
    150c:	68 11 44 00 00       	push   $0x4411
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1529:	68 11 44 00 00       	push   $0x4411
  ...
  write(fd1, "yyy", 3);
    153a:	68 6e 44 00 00       	push   $0x446e
    153f:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1555:	68 e0 87 00 00       	push   $0x87e0
    155a:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    156c:	80 3d e0 87 00 00 68 	cmpb   $0x68,0x87e0
    1573:	75 6b                	jne    15e0 <unlinkread+0x140>
  if(write(fd, buf, 10) != 10){
    1575:	83 ec 04             	sub    $0x4,%esp
    1578:	6a 0a                	push   $0xa
    157a:	68 e0 87 00 00       	push   $0x87e0
    157f:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1596:	c7 04 24 11 44 00 00 	movl   $0x4411,(%esp)
    159d:	e8 31 24 00 00       	call   39d3 <unlink>
  printf(1, "unlinkread ok\n");
    15a2:	58                   	pop    %eax
    15a3:	5a                   	pop    %edx
    15a4:	68 b9 44 00 00       	push   $0x44b9
    15a9:	6a 01                	push   $0x1
    ...
    15ba:	51                   	push   %ecx
    15bb:	51                   	push   %ecx
    15bc:	68 1c 44 00 00       	push   $0x441c
    15c1:	6a 01                	push   $0x1
    ...
    15cd:	51                   	push   %ecx
    15ce:	51                   	push   %ecx
    15cf:	68 a0 44 00 00       	push   $0x44a0
    15d4:	6a 01                	push   $0x1
    ...
    15e0:	53                   	push   %ebx
    15e1:	53                   	push   %ebx
    15e2:	68 89 44 00 00       	push   $0x4489
    15e7:	6a 01                	push   $0x1
    ...
    15f3:	56                   	push   %esi
    15f4:	56                   	push   %esi
    15f5:	68 72 44 00 00       	push   $0x4472
    15fa:	6a 01                	push   $0x1
    ...
    1606:	50                   	push   %eax
    1607:	50                   	push   %eax
    1608:	68 54 44 00 00       	push   $0x4454
    160d:	6a 01                	push   $0x1
    ...
    1619:	50                   	push   %eax
    161a:	50                   	push   %eax
    161b:	68 3c 44 00 00       	push   $0x443c
    1620:	6a 01                	push   $0x1
...
00001630 <linktest>:
{
  ...
  printf(1, "linktest\n");
    163b:	68 c8 44 00 00       	push   $0x44c8
    1640:	6a 01                	push   $0x1
    1642:	e8 d9 24 00 00       	call   3b20 <printf>
  unlink("lf1");
    1647:	c7 04 24 d2 44 00 00 	movl   $0x44d2,(%esp)
    164e:	e8 80 23 00 00       	call   39d3 <unlink>
  unlink("lf2");
    1653:	c7 04 24 d6 44 00 00 	movl   $0x44d6,(%esp)
    165a:	e8 74 23 00 00       	call   39d3 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    165f:	58                   	pop    %eax
    1660:	5a                   	pop    %edx
    1661:	68 02 02 00 00       	push   $0x202
    1666:	68 d2 44 00 00       	push   $0x44d2
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1680:	6a 05                	push   $0x5
    1682:	68 36 44 00 00       	push   $0x4436
    1687:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 d6 44 00 00       	push   $0x44d6
    16a9:	68 d2 44 00 00       	push   $0x44d2
  ...
  unlink("lf1");
    ...
    16c1:	68 d2 44 00 00       	push   $0x44d2
    16c6:	e8 08 23 00 00       	call   39d3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 d2 44 00 00       	push   $0x44d2
  ...
  fd = open("lf2", 0);
    ...
    16e7:	6a 00                	push   $0x0
    16e9:	68 d6 44 00 00       	push   $0x44d6
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1708:	68 e0 87 00 00       	push   $0x87e0
    170d:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 d6 44 00 00       	push   $0x44d6
    172f:	68 d6 44 00 00       	push   $0x44d6
  ...
  unlink("lf2");
    ...
    1747:	68 d6 44 00 00       	push   $0x44d6
    174c:	e8 82 22 00 00       	call   39d3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 d2 44 00 00       	push   $0x44d2
    1758:	68 d6 44 00 00       	push   $0x44d6
  ...
  if(link(".", "lf1") >= 0){
    ...
    176c:	68 d2 44 00 00       	push   $0x44d2
    1771:	68 9a 47 00 00       	push   $0x479a
  ...
  printf(1, "linktest ok\n");
    ...
    1785:	68 70 45 00 00       	push   $0x4570
    178a:	6a 01                	push   $0x1
    ...
    1799:	50                   	push   %eax
    179a:	50                   	push   %eax
    179b:	68 da 44 00 00       	push   $0x44da
    17a0:	6a 01                	push   $0x1
    ...
    17ac:	50                   	push   %eax
    17ad:	50                   	push   %eax
    17ae:	68 54 45 00 00       	push   $0x4554
    17b3:	6a 01                	push   $0x1
    ...
    17bf:	52                   	push   %edx
    17c0:	52                   	push   %edx
    17c1:	68 08 51 00 00       	push   $0x5108
    17c6:	6a 01                	push   $0x1
    ...
    17d2:	50                   	push   %eax
    17d3:	50                   	push   %eax
    17d4:	68 36 45 00 00       	push   $0x4536
    17d9:	6a 01                	push   $0x1
    ...
    17e5:	51                   	push   %ecx
    17e6:	51                   	push   %ecx
    17e7:	68 25 45 00 00       	push   $0x4525
    17ec:	6a 01                	push   $0x1
    ...
    17f8:	53                   	push   %ebx
    17f9:	53                   	push   %ebx
    17fa:	68 14 45 00 00       	push   $0x4514
    17ff:	6a 01                	push   $0x1
    ...
    180b:	50                   	push   %eax
    180c:	50                   	push   %eax
    180d:	68 e0 50 00 00       	push   $0x50e0
    1812:	6a 01                	push   $0x1
    ...
    181e:	51                   	push   %ecx
    181f:	51                   	push   %ecx
    1820:	68 ff 44 00 00       	push   $0x44ff
    1825:	6a 01                	push   $0x1
    ...
    1831:	50                   	push   %eax
    1832:	50                   	push   %eax
    1833:	68 ed 44 00 00       	push   $0x44ed
    1838:	6a 01                	push   $0x1
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    1862:	68 7d 45 00 00       	push   $0x457d
    1867:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1908:	53                   	push   %ebx
    1909:	68 90 45 00 00       	push   $0x4590
    190e:	6a 01                	push   $0x1
    ...
    1923:	53                   	push   %ebx
    1924:	68 8d 45 00 00       	push   $0x458d
  ...
  for(i = 0; i < 40; i++){
    1943:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1946:	53                   	push   %ebx
    1947:	68 8d 45 00 00       	push   $0x458d
  ...
  fd = open(".", 0);
    ...
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
    1976:	68 9a 47 00 00       	push   $0x479a
  ...
  printf(1, "concreate ok\n");
    ...
    1ad3:	68 e2 45 00 00       	push   $0x45e2
    1ad8:	6a 01                	push   $0x1
    ...
    1aea:	68 65 4e 00 00       	push   $0x4e65
    1aef:	6a 01                	push   $0x1
    ...
    1afb:	51                   	push   %ecx
    1afc:	51                   	push   %ecx
    1afd:	68 2c 51 00 00       	push   $0x512c
    1b02:	6a 01                	push   $0x1
    ...
    1b14:	50                   	push   %eax
    1b15:	68 c5 45 00 00       	push   $0x45c5
    1b1a:	6a 01                	push   $0x1
    ...
    1b2c:	50                   	push   %eax
    1b2d:	68 ac 45 00 00       	push   $0x45ac
    1b32:	6a 01                	push   $0x1
...
00001b50 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1b5d:	68 f0 45 00 00       	push   $0x45f0
    1b62:	6a 01                	push   $0x1
    1b64:	e8 b7 1f 00 00       	call   3b20 <printf>
  unlink("x");
    1b69:	c7 04 24 7d 48 00 00 	movl   $0x487d,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ba8:	68 7d 48 00 00       	push   $0x487d
  ...
  for(i = 0; i < 100; i++){
    ...
    1be1:	68 7d 48 00 00       	push   $0x487d
  ...
  printf(1, "linkunlink ok\n");
    ...
    1c0a:	68 05 46 00 00       	push   $0x4605
    1c0f:	6a 01                	push   $0x1
    ...
    1c23:	68 7d 48 00 00       	push   $0x487d
    1c28:	68 01 46 00 00       	push   $0x4601
    ...
    1c3a:	52                   	push   %edx
    1c3b:	52                   	push   %edx
    1c3c:	68 65 4e 00 00       	push   $0x4e65
    1c41:	6a 01                	push   $0x1
...
00001c60 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1c6d:	68 14 46 00 00       	push   $0x4614
    1c72:	6a 01                	push   $0x1
    1c74:	e8 a7 1e 00 00       	call   3b20 <printf>
  unlink("bd");
    1c79:	c7 04 24 21 46 00 00 	movl   $0x4621,(%esp)
    1c80:	e8 4e 1d 00 00       	call   39d3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 21 46 00 00       	push   $0x4621
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1cc8:	68 21 46 00 00       	push   $0x4621
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1cfb:	68 21 46 00 00       	push   $0x4621
  ...
  printf(1, "bigdir ok\n");
    ...
    1d4c:	68 63 46 00 00       	push   $0x4663
    1d51:	6a 01                	push   $0x1
    ...
    1d66:	68 3a 46 00 00       	push   $0x463a
    1d6b:	6a 01                	push   $0x1
    ...
    1d7a:	68 4e 46 00 00       	push   $0x464e
    1d7f:	6a 01                	push   $0x1
    ...
    1d8b:	50                   	push   %eax
    1d8c:	50                   	push   %eax
    1d8d:	68 24 46 00 00       	push   $0x4624
    1d92:	6a 01                	push   $0x1
...
00001da0 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1dab:	68 6e 46 00 00       	push   $0x466e
    1db0:	6a 01                	push   $0x1
    1db2:	e8 69 1d 00 00       	call   3b20 <printf>
  unlink("ff");
    1db7:	c7 04 24 f7 46 00 00 	movl   $0x46f7,(%esp)
    1dbe:	e8 10 1c 00 00       	call   39d3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 94 47 00 00 	movl   $0x4794,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de2:	68 cd 46 00 00       	push   $0x46cd
  ...
  write(fd, "ff", 2);
    ...
    1dfc:	6a 02                	push   $0x2
    1dfe:	68 f7 46 00 00       	push   $0x46f7
    1e03:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 94 47 00 00 	movl   $0x4794,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e2b:	68 a8 46 00 00       	push   $0x46a8
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e48:	68 ca 46 00 00       	push   $0x46ca
  ...
  write(fd, "FF", 2);
    ...
    1e62:	6a 02                	push   $0x2
    1e64:	68 eb 46 00 00       	push   $0x46eb
    1e69:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 ee 46 00 00       	push   $0x46ee
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e9a:	68 e0 87 00 00       	push   $0x87e0
    1e9f:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1eb1:	80 3d e0 87 00 00 66 	cmpb   $0x66,0x87e0
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1ec7:	59                   	pop    %ecx
    1ec8:	5b                   	pop    %ebx
    1ec9:	68 2e 47 00 00       	push   $0x472e
    1ece:	68 ca 46 00 00       	push   $0x46ca
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1ee6:	68 ca 46 00 00       	push   $0x46ca
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1efe:	6a 00                	push   $0x0
    1f00:	68 ca 46 00 00       	push   $0x46ca
  ...
  if(chdir("dd") != 0){
    ...
    1f18:	68 94 47 00 00       	push   $0x4794
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f30:	68 62 47 00 00       	push   $0x4762
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f48:	68 88 47 00 00       	push   $0x4788
  ...
  if(chdir("./..") != 0){
    ...
    1f60:	68 97 47 00 00       	push   $0x4797
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f78:	6a 00                	push   $0x0
    1f7a:	68 2e 47 00 00       	push   $0x472e
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f99:	68 e0 87 00 00       	push   $0x87e0
    1f9e:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 ca 46 00 00       	push   $0x46ca
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fda:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ff7:	68 07 48 00 00       	push   $0x4807
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2014:	68 94 47 00 00       	push   $0x4794
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    202c:	6a 02                	push   $0x2
    202e:	68 94 47 00 00       	push   $0x4794
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2046:	6a 01                	push   $0x1
    2048:	68 94 47 00 00       	push   $0x4794
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2060:	68 76 48 00 00       	push   $0x4876
    2065:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    207d:	68 76 48 00 00       	push   $0x4876
    2082:	68 07 48 00 00       	push   $0x4807
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    209a:	68 2e 47 00 00       	push   $0x472e
    209f:	68 cd 46 00 00       	push   $0x46cd
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    20b7:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    20cf:	68 07 48 00 00       	push   $0x4807
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20e7:	68 2e 47 00 00       	push   $0x472e
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    20ff:	68 07 48 00 00       	push   $0x4807
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2117:	68 e2 47 00 00       	push   $0x47e2
  ...
  if(chdir("dd/ff") == 0){
    ...
    212f:	68 cd 46 00 00       	push   $0x46cd
  ...
  if(chdir("dd/xx") == 0){
    ...
    2147:	68 79 48 00 00       	push   $0x4879
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    215f:	68 2e 47 00 00       	push   $0x472e
  ...
  if(unlink("dd/ff") != 0){
    ...
    2177:	68 cd 46 00 00       	push   $0x46cd
  ...
  if(unlink("dd") == 0){
    ...
    218f:	68 94 47 00 00       	push   $0x4794
  ...
  if(unlink("dd/dd") < 0){
    ...
    21a7:	68 a9 46 00 00       	push   $0x46a9
  ...
  if(unlink("dd") < 0){
    ...
    21bf:	68 94 47 00 00       	push   $0x4794
  ...
  printf(1, "subdir ok\n");
    ...
    21d7:	68 76 49 00 00       	push   $0x4976
    21dc:	6a 01                	push   $0x1
    ...
    21eb:	50                   	push   %eax
    21ec:	50                   	push   %eax
    21ed:	68 13 47 00 00       	push   $0x4713
    21f2:	6a 01                	push   $0x1
    ...
    21fe:	50                   	push   %eax
    21ff:	50                   	push   %eax
    2200:	68 6e 47 00 00       	push   $0x476e
    2205:	6a 01                	push   $0x1
    ...
    2211:	50                   	push   %eax
    2212:	50                   	push   %eax
    2213:	68 39 47 00 00       	push   $0x4739
    2218:	6a 01                	push   $0x1
    ...
    2224:	51                   	push   %ecx
    2225:	51                   	push   %ecx
    2226:	68 eb 47 00 00       	push   $0x47eb
    222b:	6a 01                	push   $0x1
    ...
    2237:	53                   	push   %ebx
    2238:	53                   	push   %ebx
    2239:	68 d0 51 00 00       	push   $0x51d0
    223e:	6a 01                	push   $0x1
    ...
    224a:	51                   	push   %ecx
    224b:	51                   	push   %ecx
    224c:	68 7f 48 00 00       	push   $0x487f
    2251:	6a 01                	push   $0x1
    ...
    225d:	53                   	push   %ebx
    225e:	53                   	push   %ebx
    225f:	68 40 52 00 00       	push   $0x5240
    2264:	6a 01                	push   $0x1
    ...
    2270:	50                   	push   %eax
    2271:	50                   	push   %eax
    2272:	68 fa 46 00 00       	push   $0x46fa
    2277:	6a 01                	push   $0x1
    ...
    2283:	51                   	push   %ecx
    2284:	51                   	push   %ecx
    2285:	68 d3 46 00 00       	push   $0x46d3
    228a:	6a 01                	push   $0x1
    ...
    2296:	50                   	push   %eax
    2297:	50                   	push   %eax
    2298:	68 9c 47 00 00       	push   $0x479c
    229d:	6a 01                	push   $0x1
    ...
    22a9:	52                   	push   %edx
    22aa:	52                   	push   %edx
    22ab:	68 88 51 00 00       	push   $0x5188
    22b0:	6a 01                	push   $0x1
    ...
    22bc:	50                   	push   %eax
    22bd:	50                   	push   %eax
    22be:	68 1c 52 00 00       	push   $0x521c
    22c3:	6a 01                	push   $0x1
    ...
    22cf:	50                   	push   %eax
    22d0:	50                   	push   %eax
    22d1:	68 f8 51 00 00       	push   $0x51f8
    22d6:	6a 01                	push   $0x1
    ...
    22e2:	50                   	push   %eax
    22e3:	50                   	push   %eax
    22e4:	68 5b 48 00 00       	push   $0x485b
    22e9:	6a 01                	push   $0x1
    ...
    22f5:	50                   	push   %eax
    22f6:	50                   	push   %eax
    22f7:	68 42 48 00 00       	push   $0x4842
    22fc:	6a 01                	push   $0x1
    ...
    2308:	50                   	push   %eax
    2309:	50                   	push   %eax
    230a:	68 2c 48 00 00       	push   $0x482c
    230f:	6a 01                	push   $0x1
    ...
    231b:	52                   	push   %edx
    231c:	52                   	push   %edx
    231d:	68 10 48 00 00       	push   $0x4810
    2322:	6a 01                	push   $0x1
    ...
    232e:	50                   	push   %eax
    232f:	50                   	push   %eax
    2330:	68 51 47 00 00       	push   $0x4751
    2335:	6a 01                	push   $0x1
    ...
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    2343:	68 ac 51 00 00       	push   $0x51ac
    2348:	6a 01                	push   $0x1
    ...
    2354:	53                   	push   %ebx
    2355:	53                   	push   %ebx
    2356:	68 af 46 00 00       	push   $0x46af
    235b:	6a 01                	push   $0x1
    ...
    2367:	50                   	push   %eax
    2368:	50                   	push   %eax
    2369:	68 60 51 00 00       	push   $0x5160
    236e:	6a 01                	push   $0x1
    ...
    237a:	50                   	push   %eax
    237b:	50                   	push   %eax
    237c:	68 93 46 00 00       	push   $0x4693
    2381:	6a 01                	push   $0x1
    ...
    238d:	50                   	push   %eax
    238e:	50                   	push   %eax
    238f:	68 7b 46 00 00       	push   $0x467b
    2394:	6a 01                	push   $0x1
    ...
    23a0:	50                   	push   %eax
    23a1:	50                   	push   %eax
    23a2:	68 64 49 00 00       	push   $0x4964
    23a7:	6a 01                	push   $0x1
    ...
    23b3:	52                   	push   %edx
    23b4:	52                   	push   %edx
    23b5:	68 4f 49 00 00       	push   $0x494f
    23ba:	6a 01                	push   $0x1
    ...
    23c6:	51                   	push   %ecx
    23c7:	51                   	push   %ecx
    23c8:	68 64 52 00 00       	push   $0x5264
    23cd:	6a 01                	push   $0x1
    ...
    23d9:	53                   	push   %ebx
    23da:	53                   	push   %ebx
    23db:	68 3a 49 00 00       	push   $0x493a
    23e0:	6a 01                	push   $0x1
    ...
    23ec:	50                   	push   %eax
    23ed:	50                   	push   %eax
    23ee:	68 22 49 00 00       	push   $0x4922
    23f3:	6a 01                	push   $0x1
    ...
    23ff:	50                   	push   %eax
    2400:	50                   	push   %eax
    2401:	68 0a 49 00 00       	push   $0x490a
    2406:	6a 01                	push   $0x1
    ...
    2412:	50                   	push   %eax
    2413:	50                   	push   %eax
    2414:	68 ee 48 00 00       	push   $0x48ee
    2419:	6a 01                	push   $0x1
    ...
    2425:	50                   	push   %eax
    2426:	50                   	push   %eax
    2427:	68 d2 48 00 00       	push   $0x48d2
    242c:	6a 01                	push   $0x1
    ...
    2438:	50                   	push   %eax
    2439:	50                   	push   %eax
    243a:	68 b5 48 00 00       	push   $0x48b5
    243f:	6a 01                	push   $0x1
    ...
    244b:	52                   	push   %edx
    244c:	52                   	push   %edx
    244d:	68 9a 48 00 00       	push   $0x489a
    2452:	6a 01                	push   $0x1
    ...
    2471:	53                   	push   %ebx
    2472:	53                   	push   %ebx
    2473:	68 af 47 00 00       	push   $0x47af
    2478:	6a 01                	push   $0x1
...
00002490 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    24a1:	68 81 49 00 00       	push   $0x4981
    24a6:	6a 01                	push   $0x1
    24a8:	e8 73 16 00 00       	call   3b20 <printf>
  unlink("bigwrite");
    24ad:	c7 04 24 90 49 00 00 	movl   $0x4990,(%esp)
    ...
    24c8:	68 90 49 00 00       	push   $0x4990
    ...
    24de:	53                   	push   %ebx
    24df:	68 e0 87 00 00       	push   $0x87e0
    24e4:	50                   	push   %eax
    ...
    24f4:	53                   	push   %ebx
    24f5:	68 e0 87 00 00       	push   $0x87e0
    24fa:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2516:	c7 04 24 90 49 00 00 	movl   $0x4990,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2530:	68 c3 49 00 00       	push   $0x49c3
    2535:	6a 01                	push   $0x1
    ...
    2546:	50                   	push   %eax
    2547:	53                   	push   %ebx
    2548:	68 b1 49 00 00       	push   $0x49b1
    254d:	6a 01                	push   $0x1
    ...
    255c:	68 99 49 00 00       	push   $0x4999
    2561:	6a 01                	push   $0x1
...
00002570 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 ec 49 00 00       	push   $0x49ec
  ...
  for(i = 0; ; i++){
    ...
    262d:	0f be 05 e0 87 00 00 	movsbl 0x87e0,%eax
    2634:	d1 fa                	sar    %edx
    2636:	39 d0                	cmp    %edx,%eax
    2638:	75 6e                	jne    26a8 <bigfile+0x138>
    263a:	0f be 15 0b 89 00 00 	movsbl 0x890b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2656:	68 e0 87 00 00       	push   $0x87e0
    265b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    2685:	68 ec 49 00 00       	push   $0x49ec
    268a:	e8 44 13 00 00       	call   39d3 <unlink>
  printf(1, "bigfile test ok\n");
    268f:	58                   	pop    %eax
    2690:	5a                   	pop    %edx
    2691:	68 7b 4a 00 00       	push   $0x4a7b
    2696:	6a 01                	push   $0x1
    ...
    26ab:	68 48 4a 00 00       	push   $0x4a48
    26b0:	6a 01                	push   $0x1
    ...
    26bf:	68 34 4a 00 00       	push   $0x4a34
    26c4:	6a 01                	push   $0x1
    ...
    26d3:	68 1f 4a 00 00       	push   $0x4a1f
    26d8:	6a 01                	push   $0x1
    ...
    26e7:	68 f4 49 00 00       	push   $0x49f4
    26ec:	6a 01                	push   $0x1
    ...
    26f8:	53                   	push   %ebx
    26f9:	53                   	push   %ebx
    26fa:	68 0a 4a 00 00       	push   $0x4a0a
    26ff:	6a 01                	push   $0x1
    ...
    270b:	50                   	push   %eax
    270c:	50                   	push   %eax
    270d:	68 de 49 00 00       	push   $0x49de
    2712:	6a 01                	push   $0x1
    ...
    271e:	51                   	push   %ecx
    271f:	51                   	push   %ecx
    2720:	68 61 4a 00 00       	push   $0x4a61
    2725:	6a 01                	push   $0x1
...
00002740 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    274a:	68 8c 4a 00 00       	push   $0x4a8c
    274f:	6a 01                	push   $0x1
    2751:	e8 ca 13 00 00       	call   3b20 <printf>
  if(mkdir("12345678901234") != 0){
    2756:	c7 04 24 c7 4a 00 00 	movl   $0x4ac7,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2770:	68 84 52 00 00       	push   $0x5284
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    278d:	68 d4 52 00 00       	push   $0x52d4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 44 53 00 00       	push   $0x5344
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 b8 4a 00 00 	movl   $0x4ab8,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27df:	68 e0 53 00 00       	push   $0x53e0
  ...
  printf(1, "fourteen ok\n");
    ...
    27f3:	68 d6 4a 00 00       	push   $0x4ad6
    27f8:	6a 01                	push   $0x1
    ...
    2804:	50                   	push   %eax
    2805:	50                   	push   %eax
    2806:	68 9b 4a 00 00       	push   $0x4a9b
    280b:	6a 01                	push   $0x1
    ...
    2817:	50                   	push   %eax
    2818:	50                   	push   %eax
    2819:	68 00 54 00 00       	push   $0x5400
    281e:	6a 01                	push   $0x1
    ...
    282a:	52                   	push   %edx
    282b:	52                   	push   %edx
    282c:	68 b0 53 00 00       	push   $0x53b0
    2831:	6a 01                	push   $0x1
    ...
    283d:	51                   	push   %ecx
    283e:	51                   	push   %ecx
    283f:	68 74 53 00 00       	push   $0x5374
    2844:	6a 01                	push   $0x1
    ...
    2850:	51                   	push   %ecx
    2851:	51                   	push   %ecx
    2852:	68 04 53 00 00       	push   $0x5304
    2857:	6a 01                	push   $0x1
    ...
    2863:	50                   	push   %eax
    2864:	50                   	push   %eax
    2865:	68 a4 52 00 00       	push   $0x52a4
    286a:	6a 01                	push   $0x1
...
00002880 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    288a:	68 e3 4a 00 00       	push   $0x4ae3
    288f:	6a 01                	push   $0x1
    2891:	e8 8a 12 00 00       	call   3b20 <printf>
  if(mkdir("dots") != 0){
    2896:	c7 04 24 ef 4a 00 00 	movl   $0x4aef,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    28b0:	68 ef 4a 00 00       	push   $0x4aef
  ...
  if(unlink(".") == 0){
    ...
    28c8:	68 9a 47 00 00       	push   $0x479a
  ...
  if(unlink("..") == 0){
    ...
    28e0:	68 99 47 00 00       	push   $0x4799
  ...
  if(chdir("/") != 0){
    ...
    28f8:	68 6d 3f 00 00       	push   $0x3f6d
  ...
  if(unlink("dots/.") == 0){
    ...
    2910:	68 37 4b 00 00       	push   $0x4b37
  ...
  if(unlink("dots/..") == 0){
    ...
    2924:	68 55 4b 00 00       	push   $0x4b55
  ...
  if(unlink("dots") != 0){
    ...
    2938:	68 ef 4a 00 00       	push   $0x4aef
  ...
  printf(1, "rmdot ok\n");
    ...
    294c:	68 8a 4b 00 00       	push   $0x4b8a
    2951:	6a 01                	push   $0x1
    ...
    295d:	50                   	push   %eax
    295e:	50                   	push   %eax
    295f:	68 f4 4a 00 00       	push   $0x4af4
    2964:	6a 01                	push   $0x1
    ...
    2970:	50                   	push   %eax
    2971:	50                   	push   %eax
    2972:	68 75 4b 00 00       	push   $0x4b75
    2977:	6a 01                	push   $0x1
    ...
    2983:	52                   	push   %edx
    2984:	52                   	push   %edx
    2985:	68 5d 4b 00 00       	push   $0x4b5d
    298a:	6a 01                	push   $0x1
    ...
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    2998:	68 3e 4b 00 00       	push   $0x4b3e
    299d:	6a 01                	push   $0x1
    ...
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    29ab:	68 6f 3f 00 00       	push   $0x3f6f
    29b0:	6a 01                	push   $0x1
    ...
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    29be:	68 28 4b 00 00       	push   $0x4b28
    29c3:	6a 01                	push   $0x1
    ...
    29cf:	50                   	push   %eax
    29d0:	50                   	push   %eax
    29d1:	68 1a 4b 00 00       	push   $0x4b1a
    29d6:	6a 01                	push   $0x1
    ...
    29e2:	50                   	push   %eax
    29e3:	50                   	push   %eax
    29e4:	68 07 4b 00 00       	push   $0x4b07
    29e9:	6a 01                	push   $0x1
...
00002a00 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2a0b:	68 94 4b 00 00       	push   $0x4b94
    2a10:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a1e:	68 a1 4b 00 00       	push   $0x4ba1
  ...
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 a1 4b 00 00 	movl   $0x4ba1,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a56:	6a 00                	push   $0x0
    2a58:	68 da 4b 00 00       	push   $0x4bda
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a75:	68 da 4b 00 00       	push   $0x4bda
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a8d:	68 da 4b 00 00       	push   $0x4bda
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aa5:	68 da 4b 00 00       	push   $0x4bda
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2abd:	68 da 4b 00 00       	push   $0x4bda
    2ac2:	68 3e 4c 00 00       	push   $0x4c3e
  ...
  if(unlink("dirfile") != 0){
    ...
    2ada:	68 a1 4b 00 00       	push   $0x4ba1
  ...
  fd = open(".", O_RDWR);
    ...
    2af2:	6a 02                	push   $0x2
    2af4:	68 9a 47 00 00       	push   $0x479a
  ...
  fd = open(".", 0);
    ...
    2b0c:	6a 00                	push   $0x0
    2b0e:	68 9a 47 00 00       	push   $0x479a
  ...
  if(write(fd, "x", 1) > 0){
    2b1f:	68 7d 48 00 00       	push   $0x487d
    2b24:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2b3a:	58                   	pop    %eax
    2b3b:	5a                   	pop    %edx
    2b3c:	68 71 4c 00 00       	push   $0x4c71
    2b41:	6a 01                	push   $0x1
    ...
    2b50:	50                   	push   %eax
    2b51:	50                   	push   %eax
    2b52:	68 e5 4b 00 00       	push   $0x4be5
    2b57:	6a 01                	push   $0x1
    ...
    2b63:	52                   	push   %edx
    2b64:	52                   	push   %edx
    2b65:	68 c0 4b 00 00       	push   $0x4bc0
    2b6a:	6a 01                	push   $0x1
    ...
    2b76:	51                   	push   %ecx
    2b77:	51                   	push   %ecx
    2b78:	68 a9 4b 00 00       	push   $0x4ba9
    2b7d:	6a 01                	push   $0x1
    ...
    2b89:	51                   	push   %ecx
    2b8a:	51                   	push   %ecx
    2b8b:	68 5d 4c 00 00       	push   $0x4c5d
    2b90:	6a 01                	push   $0x1
    ...
    2b9c:	53                   	push   %ebx
    2b9d:	53                   	push   %ebx
    2b9e:	68 54 54 00 00       	push   $0x5454
    2ba3:	6a 01                	push   $0x1
    ...
    2baf:	50                   	push   %eax
    2bb0:	50                   	push   %eax
    2bb1:	68 45 4c 00 00       	push   $0x4c45
    2bb6:	6a 01                	push   $0x1
    ...
    2bc2:	50                   	push   %eax
    2bc3:	50                   	push   %eax
    2bc4:	68 34 54 00 00       	push   $0x5434
    2bc9:	6a 01                	push   $0x1
    ...
    2bd5:	50                   	push   %eax
    2bd6:	50                   	push   %eax
    2bd7:	68 20 4c 00 00       	push   $0x4c20
    2bdc:	6a 01                	push   $0x1
    ...
    2be8:	50                   	push   %eax
    2be9:	50                   	push   %eax
    2bea:	68 03 4c 00 00       	push   $0x4c03
    2bef:	6a 01                	push   $0x1
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2c10:	68 81 4c 00 00       	push   $0x4c81
    2c15:	6a 01                	push   $0x1
    ...
    2c23:	68 92 4c 00 00       	push   $0x4c92
    ...
    2c3b:	68 92 4c 00 00       	push   $0x4c92
    ...
    2c53:	68 ee 56 00 00       	push   $0x56ee
    2c58:	e8 8e 0d 00 00       	call   39eb <mkdir>
    link("README", "");
    2c5d:	59                   	pop    %ecx
    2c5e:	58                   	pop    %eax
    2c5f:	68 ee 56 00 00       	push   $0x56ee
    2c64:	68 3e 4c 00 00       	push   $0x4c3e
    2c69:	e8 75 0d 00 00       	call   39e3 <link>
    fd = open("", O_CREATE);
    2c6e:	58                   	pop    %eax
    2c6f:	5a                   	pop    %edx
    2c70:	68 00 02 00 00       	push   $0x200
    2c75:	68 ee 56 00 00       	push   $0x56ee
    ...
    2c9a:	68 7c 48 00 00       	push   $0x487c
    ...
    2cba:	68 7c 48 00 00       	push   $0x487c
  ...
  chdir("/");
    ...
    2cd3:	68 6d 3f 00 00       	push   $0x3f6d
    2cd8:	e8 16 0d 00 00       	call   39f3 <chdir>
  printf(1, "empty file name OK\n");
    2cdd:	58                   	pop    %eax
    2cde:	5a                   	pop    %edx
    2cdf:	68 c0 4c 00 00       	push   $0x4cc0
    2ce4:	6a 01                	push   $0x1
    ...
    2cf6:	68 98 4c 00 00       	push   $0x4c98
    2cfb:	6a 01                	push   $0x1
    ...
    2d0a:	68 ac 4c 00 00       	push   $0x4cac
    2d0f:	6a 01                	push   $0x1
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2d2d:	68 d4 4c 00 00       	push   $0x4cd4
    2d32:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2d7b:	68 06 4d 00 00       	push   $0x4d06
    2d80:	6a 01                	push   $0x1
    ...
    2d94:	68 df 4c 00 00       	push   $0x4cdf
    2d99:	6a 01                	push   $0x1
    ...
    2da5:	52                   	push   %edx
    2da6:	52                   	push   %edx
    2da7:	68 f3 4c 00 00       	push   $0x4cf3
    2dac:	6a 01                	push   $0x1
    ...
    2db8:	50                   	push   %eax
    2db9:	50                   	push   %eax
    2dba:	68 74 54 00 00       	push   $0x5474
    2dbf:	6a 01                	push   $0x1
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2ddf:	68 14 4d 00 00       	push   $0x4d14
    2de4:	ff 35 04 60 00 00    	pushl  0x6004
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3034:	68 bc 4d 00 00       	push   $0x4dbc
    3039:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    306d:	6a 01                	push   $0x1
    306f:	68 7d 48 00 00       	push   $0x487d
    ...
    30af:	56                   	push   %esi
    30b0:	57                   	push   %edi
    30b1:	68 1f 4d 00 00       	push   $0x4d1f
    30b6:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    30c9:	50                   	push   %eax
    30ca:	50                   	push   %eax
    30cb:	68 a1 4d 00 00       	push   $0x4da1
    30d0:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    30e0:	52                   	push   %edx
    30e1:	52                   	push   %edx
    30e2:	68 5d 42 00 00       	push   $0x425d
    30e7:	6a 01                	push   $0x1
    ...
    30fb:	50                   	push   %eax
    30fc:	56                   	push   %esi
    30fd:	68 88 4d 00 00       	push   $0x4d88
    3102:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    311d:	68 65 4e 00 00       	push   $0x4e65
    3122:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3132:	50                   	push   %eax
    3133:	56                   	push   %esi
    3134:	68 68 55 00 00       	push   $0x5568
    3139:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3149:	51                   	push   %ecx
    314a:	51                   	push   %ecx
    314b:	68 38 55 00 00       	push   $0x5538
    3150:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3160:	57                   	push   %edi
    3161:	56                   	push   %esi
    3162:	68 10 55 00 00       	push   $0x5510
    3167:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3177:	50                   	push   %eax
    3178:	56                   	push   %esi
    3179:	68 d8 54 00 00       	push   $0x54d8
    317e:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    318e:	53                   	push   %ebx
    318f:	53                   	push   %ebx
    3190:	68 6d 4d 00 00       	push   $0x4d6d
    3195:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    31a5:	56                   	push   %esi
    31a6:	56                   	push   %esi
    31a7:	68 98 54 00 00       	push   $0x5498
    31ac:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    31c1:	57                   	push   %edi
    31c2:	57                   	push   %edi
    31c3:	68 51 4d 00 00       	push   $0x4d51
    31c8:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    31d8:	50                   	push   %eax
    31d9:	50                   	push   %eax
    31da:	68 3a 4d 00 00       	push   $0x4d3a
    31df:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    320e:	68 ca 4d 00 00       	push   $0x4dca
    3213:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3257:	5a                   	pop    %edx
    3258:	56                   	push   %esi
    3259:	68 d9 4d 00 00       	push   $0x4dd9
  ...
  printf(stdout, "validate ok\n");
    ...
    327c:	68 fd 4d 00 00       	push   $0x4dfd
    3281:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    329e:	68 e4 4d 00 00       	push   $0x4de4
    32a3:	ff 35 04 60 00 00    	pushl  0x6004
...
000032c0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32ca:	68 0a 4e 00 00       	push   $0x4e0a
    32cf:	ff 35 04 60 00 00    	pushl  0x6004
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    32df:	90                   	nop
    if(uninit[i] != '\0'){
    32e0:	80 b8 c0 60 00 00 00 	cmpb   $0x0,0x60c0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    32f6:	68 25 4e 00 00       	push   $0x4e25
    32fb:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    330e:	68 14 4e 00 00       	push   $0x4e14
    3313:	ff 35 04 60 00 00    	pushl  0x6004
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    333a:	68 32 4e 00 00       	push   $0x4e32
  ...
  fd = open("bigarg-ok", 0);
    ...
    335e:	6a 00                	push   $0x0
    3360:	68 32 4e 00 00       	push   $0x4e32
  ...
  unlink("bigarg-ok");
    337e:	c7 04 24 32 4e 00 00 	movl   $0x4e32,(%esp)
    ...
    3390:	c7 04 85 20 60 00 00 	movl   $0x558c,0x6020(,%eax,4)
    3397:	8c 55 00 00 
    ...
    33a3:	51                   	push   %ecx
    33a4:	51                   	push   %ecx
    33a5:	68 3c 4e 00 00       	push   $0x4e3c
    33aa:	ff 35 04 60 00 00    	pushl  0x6004
    args[MAXARG-1] = 0;
    33b0:	c7 05 9c 60 00 00 00 	movl   $0x0,0x609c
    33b7:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    33bf:	58                   	pop    %eax
    33c0:	5a                   	pop    %edx
    33c1:	68 20 60 00 00       	push   $0x6020
    33c6:	68 09 40 00 00       	push   $0x4009
    33cb:	e8 eb 05 00 00       	call   39bb <exec>
    printf(stdout, "bigarg test ok\n");
    33d0:	59                   	pop    %ecx
    33d1:	58                   	pop    %eax
    33d2:	68 49 4e 00 00       	push   $0x4e49
    33d7:	ff 35 04 60 00 00    	pushl  0x6004
    33dd:	e8 3e 07 00 00       	call   3b20 <printf>
    fd = open("bigarg-ok", O_CREATE);
    33e2:	58                   	pop    %eax
    33e3:	5a                   	pop    %edx
    33e4:	68 00 02 00 00       	push   $0x200
    33e9:	68 32 4e 00 00       	push   $0x4e32
    ...
    3400:	50                   	push   %eax
    3401:	50                   	push   %eax
    3402:	68 72 4e 00 00       	push   $0x4e72
    3407:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3417:	52                   	push   %edx
    3418:	52                   	push   %edx
    3419:	68 59 4e 00 00       	push   $0x4e59
    341e:	ff 35 04 60 00 00    	pushl  0x6004
    ...
    3439:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    343f:	68 87 4e 00 00       	push   $0x4e87
    3444:	6a 01                	push   $0x1
    ...
    34c3:	50                   	push   %eax
    34c4:	68 94 4e 00 00       	push   $0x4e94
    34c9:	6a 01                	push   $0x1
    ...
    34fa:	68 e0 87 00 00       	push   $0x87e0
    34ff:	57                   	push   %edi
    ...
    3512:	53                   	push   %ebx
    3513:	68 b0 4e 00 00       	push   $0x4eb0
    3518:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    353c:	50                   	push   %eax
    353d:	68 a0 4e 00 00       	push   $0x4ea0
    3542:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    35ee:	68 c0 4e 00 00       	push   $0x4ec0
    35f3:	6a 01                	push   $0x1
...
00003610 <uio>:
{
  ...
  printf(1, "uio test\n");
    361a:	68 d6 4e 00 00       	push   $0x4ed6
    361f:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    363c:	68 e0 4e 00 00       	push   $0x4ee0
    3641:	6a 01                	push   $0x1
    ...
    365e:	52                   	push   %edx
    365f:	52                   	push   %edx
    3660:	68 6c 56 00 00       	push   $0x566c
    3665:	6a 01                	push   $0x1
    ...
    3671:	50                   	push   %eax
    3672:	50                   	push   %eax
    3673:	68 65 4e 00 00       	push   $0x4e65
    3678:	6a 01                	push   $0x1
...
00003690 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    369b:	6a 00                	push   $0x0
    369d:	68 ef 4e 00 00       	push   $0x4eef
  ...
  printf(1, "arg test passed\n");
    36d1:	58                   	pop    %eax
    36d2:	5a                   	pop    %edx
    36d3:	68 01 4f 00 00       	push   $0x4f01
    36d8:	6a 01                	push   $0x1
    ...
    36e7:	51                   	push   %ecx
    36e8:	51                   	push   %ecx
    36e9:	68 f4 4e 00 00       	push   $0x4ef4
    36ee:	6a 02                	push   $0x2
...
00003700 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3704:	69 05 00 60 00 00 0d 	imul   $0x19660d,0x6000,%eax
    370b:	66 19 00 
    370e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3713:	a3 00 60 00 00       	mov    %eax,0x6000
}
    3718:	c3                   	ret    
    ...
    3a7c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3aa9:	0f b6 92 c4 56 00 00 	movzbl 0x56c4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3ca4:	eb 1a                	jmp    3cc0 <printf+0x1a0>
          s = "(null)";
    3ca6:	bb ba 56 00 00       	mov    $0x56ba,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cf5:	a1 a0 60 00 00       	mov    0x60a0,%eax
{
    ...
    3d16:	73 10                	jae    3d28 <free+0x38>
{
  ...
  freep = p;
    ...
    3d41:	5b                   	pop    %ebx
  freep = p;
    3d42:	a3 a0 60 00 00       	mov    %eax,0x60a0
}
    3d47:	5e                   	pop    %esi
    3d48:	5f                   	pop    %edi
    3d49:	5d                   	pop    %ebp
  ...
  freep = p;
    3d6a:	a3 a0 60 00 00       	mov    %eax,0x60a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d90:	8b 3d a0 60 00 00    	mov    0x60a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3dd9:	8b 3d a0 60 00 00    	mov    0x60a0,%edi
  ...
  return freep;
    3e07:	a1 a0 60 00 00       	mov    0x60a0,%eax
    ...
    3e34:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3e37:	a3 a0 60 00 00       	mov    %eax,0x60a0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e50:	c7 05 a0 60 00 00 a4 	movl   $0x60a4,0x60a0
    3e57:	60 00 00 
    base.s.size = 0;
    3e5a:	bf a4 60 00 00       	mov    $0x60a4,%edi
    base.s.ptr = freep = prevp = &base;
    3e5f:	c7 05 a4 60 00 00 a4 	movl   $0x60a4,0x60a4
    3e66:	60 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e69:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e6b:	c7 05 a8 60 00 00 00 	movl   $0x0,0x60a8
    3e72:	00 00 00 
    if(p->s.size >= nunits){
    ...
    3e86:	66 90                	xchg   %ax,%ax
    3e88:	66 90                	xchg   %ax,%ax
    3e8a:	66 90                	xchg   %ax,%ax
    3e8c:	66 90                	xchg   %ax,%ax
    3e8e:	66 90                	xchg   %ax,%ax

00003e90 <thread_creator>:
#include "stat.h"
#include "user.h"
...
int thread_creator (void (*fn) (void *), void *args) {
    ...
    3e97:	53                   	push   %ebx
    3e98:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
    3e9b:	68 00 20 00 00       	push   $0x2000
    3ea0:	e8 db fe ff ff       	call   3d80 <malloc>
    void *stack;

    if (fptr == 0)
    3ea5:	83 c4 10             	add    $0x10,%esp
    3ea8:	85 c0                	test   %eax,%eax
    3eaa:	74 59                	je     3f05 <thread_creator+0x75>
    3eac:	89 c3                	mov    %eax,%ebx
        return -1;
    
    int mod = (uint)fptr % PAGESIZE;

    if (mod == 0)
    3eae:	25 ff 0f 00 00       	and    $0xfff,%eax
    3eb3:	75 1b                	jne    3ed0 <thread_creator+0x40>
        stack = fptr;
    else
        stack = fptr + (PAGESIZE - mod);
    
    int thread_id = thread_create((void*)stack);
    3eb5:	83 ec 0c             	sub    $0xc,%esp
    3eb8:	53                   	push   %ebx
    3eb9:	e8 7d fb ff ff       	call   3a3b <thread_create>

    if (thread_id < 0)
    3ebe:	83 c4 10             	add    $0x10,%esp
    3ec1:	85 c0                	test   %eax,%eax
    3ec3:	78 23                	js     3ee8 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
    3ec5:	74 45                	je     3f0c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
    ...
    3ec7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3eca:	c9                   	leave  
    3ecb:	c3                   	ret    
    3ecc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        stack = fptr + (PAGESIZE - mod);
    3ed0:	29 c3                	sub    %eax,%ebx
    int thread_id = thread_create((void*)stack);
    3ed2:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
    3ed5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
    3edb:	53                   	push   %ebx
    3edc:	e8 5a fb ff ff       	call   3a3b <thread_create>
    if (thread_id < 0)
    3ee1:	83 c4 10             	add    $0x10,%esp
    3ee4:	85 c0                	test   %eax,%eax
    3ee6:	79 dd                	jns    3ec5 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
    3ee8:	83 ec 08             	sub    $0x8,%esp
    3eeb:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3eee:	68 d5 56 00 00       	push   $0x56d5
    3ef3:	6a 01                	push   $0x1
    3ef5:	e8 26 fc ff ff       	call   3b20 <printf>
    3efa:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
    3efd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3f00:	83 c4 10             	add    $0x10,%esp
    3f03:	c9                   	leave  
    3f04:	c3                   	ret    
        return -1;
    3f05:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3f0a:	eb bb                	jmp    3ec7 <thread_creator+0x37>
        (fn)(args);
    3f0c:	83 ec 0c             	sub    $0xc,%esp
    3f0f:	ff 75 0c             	pushl  0xc(%ebp)
    3f12:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
    3f15:	89 1c 24             	mov    %ebx,(%esp)
    3f18:	e8 d3 fd ff ff       	call   3cf0 <free>
        exit();
    3f1d:	e8 61 fa ff ff       	call   3983 <exit>
