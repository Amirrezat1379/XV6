 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb 54 08 00 00       	mov    $0x854,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 4c 0b 00 00       	mov    0xb4c,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 ...
 77e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 50 0b 00 00       	mov    $0xb50,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 7a2:	00 00 00 
    if(p->s.size >= nunits){
