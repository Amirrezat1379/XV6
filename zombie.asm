 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 2c 0b 00 00       	mov    %eax,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 2c 0b 00 00       	mov    0xb2c,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
