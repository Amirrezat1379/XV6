  ...
  14:	bb 06 00 00 00       	mov    $0x6,%ebx
{
  ...
  1a:	83 ec 18             	sub    $0x18,%esp
    int main_pid = getpid();
  1d:	e8 01 04 00 00       	call   423 <getpid>
  22:	89 c6                	mov    %eax,%esi
    ...
    {
        if (fork() > 0)
  24:	e8 72 03 00 00       	call   39b <fork>
  29:	85 c0                	test   %eax,%eax
  2b:	7f 05                	jg     32 <main+0x32>
    for (int i = 0; i < NUM; i++)
  2d:	83 eb 01             	sub    $0x1,%ebx
  30:	75 f2                	jne    24 <main+0x24>
            break;
    }

    if (main_pid != getpid())
  32:	e8 ec 03 00 00       	call   423 <getpid>
  37:	39 f0                	cmp    %esi,%eax
  39:	0f 84 da 00 00 00    	je     119 <main+0x119>
    {
        //print pid with i
        for (int i = 0; i < 8; i++){
  ...
  41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            int pid = getpid();
  48:	e8 d6 03 00 00       	call   423 <getpid>
            printf(1, "PID=/%d/ : i=/%d/\n",pid , i);
  4d:	53                   	push   %ebx
        for (int i = 0; i < 8; i++){
  4e:	83 c3 01             	add    $0x1,%ebx
            printf(1, "PID=/%d/ : i=/%d/\n",pid , i);
  51:	50                   	push   %eax
  52:	68 44 09 00 00       	push   $0x944
  57:	6a 01                	push   $0x1
  59:	e8 e2 04 00 00       	call   540 <printf>
        for (int i = 0; i < 8; i++){
  5e:	83 c4 10             	add    $0x10,%esp
  61:	83 fb 08             	cmp    $0x8,%ebx
  64:	75 e2                	jne    48 <main+0x48>
        }

        int thisPid = getpid(); 
  66:	e8 b8 03 00 00       	call   423 <getpid>
  ...
  94:	89 c6                	mov    %eax,%esi
        printf(1,"cccccccccccppppptttttttttt %d\n",cbpTime);
  96:	68 f8 09 00 00       	push   $0x9f8
  9b:	6a 01                	push   $0x1
  9d:	e8 9e 04 00 00       	call   540 <printf>
        sum=cbpTime;
        s[0] += sum;
  ...
  a5:	56                   	push   %esi
  a6:	68 18 0a 00 00       	push   $0xa18
  ab:	6a 01                	push   $0x1
  ad:	e8 8e 04 00 00       	call   540 <printf>


        printf(1, " Process ID : %d\n", thisPid);
  b2:	83 c4 0c             	add    $0xc,%esp
  b5:	53                   	push   %ebx
  b6:	68 57 09 00 00       	push   $0x957
  bb:	6a 01                	push   $0x1
  bd:	e8 7e 04 00 00       	call   540 <printf>
        printf(1,"--------------------------\n");
  c2:	5a                   	pop    %edx
  c3:	59                   	pop    %ecx
  c4:	68 69 09 00 00       	push   $0x969
  c9:	6a 01                	push   $0x1
  cb:	e8 70 04 00 00       	call   540 <printf>
        printf(1, "| TurnAround Time = %d  | \n", turnAroundTime);
  d0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  ...
  e6:	57                   	push   %edi
  e7:	68 a1 09 00 00       	push   $0x9a1
  ec:	6a 01                	push   $0x1
  ee:	e8 4d 04 00 00       	call   540 <printf>
        printf(1, "| CPU Burst Time = %d    | \n", cbpTime);
  f3:	83 c4 0c             	add    $0xc,%esp
  f6:	56                   	push   %esi
  f7:	68 bd 09 00 00       	push   $0x9bd
  fc:	6a 01                	push   $0x1
  fe:	e8 3d 04 00 00       	call   540 <printf>
        printf(1, "\n\n");
 103:	5b                   	pop    %ebx
 104:	5e                   	pop    %esi
 105:	68 da 09 00 00       	push   $0x9da
 10a:	6a 01                	push   $0x1
 10c:	e8 2f 04 00 00       	call   540 <printf>
 111:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
 114:	e8 8a 02 00 00       	call   3a3 <exit>
        wait();
 119:	e8 8d 02 00 00       	call   3ab <wait>
        printf(1,"assqwqwqwqwqdewwdweaw %d",t);
 11e:	50                   	push   %eax
 11f:	6a 00                	push   $0x0
 121:	68 dd 09 00 00       	push   $0x9dd
 126:	6a 01                	push   $0x1
 128:	e8 13 04 00 00       	call   540 <printf>
 12d:	83 c4 10             	add    $0x10,%esp
 130:	eb e2                	jmp    114 <main+0x114>
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 48 0a 00 00 	movzbl 0xa48(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb 40 0a 00 00       	mov    $0xa40,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 715:	a1 00 10 00 00       	mov    0x1000,%eax
{
 ...
 736:	73 10                	jae    748 <free+0x38>
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	a3 00 10 00 00       	mov    %eax,0x1000
}
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 769:	5d                   	pop    %ebp
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 00 10 00 00       	mov    %eax,0x1000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7b0:	8b 3d 00 10 00 00    	mov    0x1000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	8b 3d 00 10 00 00    	mov    0x1000,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 00 10 00 00       	mov    0x1000,%eax
 ...
 854:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 857:	a3 00 10 00 00       	mov    %eax,0x1000
}
 ...
 86e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 00 10 00 00 04 	movl   $0x1004,0x1000
 877:	10 00 00 
    base.s.size = 0;
 87a:	bf 04 10 00 00       	mov    $0x1004,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 04 10 00 00 04 	movl   $0x1004,0x1004
 886:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 88b:	c7 05 08 10 00 00 00 	movl   $0x0,0x1008
 892:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 8b7:	53                   	push   %ebx
 8b8:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
 8bb:	68 00 20 00 00       	push   $0x2000
 8c0:	e8 db fe ff ff       	call   7a0 <malloc>
    void *stack;

    if (fptr == 0)
 8c5:	83 c4 10             	add    $0x10,%esp
 8c8:	85 c0                	test   %eax,%eax
 8ca:	74 59                	je     925 <thread_creator+0x75>
 8cc:	89 c3                	mov    %eax,%ebx
        return -1;
    
    int mod = (uint)fptr % PAGESIZE;

    if (mod == 0)
 8ce:	25 ff 0f 00 00       	and    $0xfff,%eax
 8d3:	75 1b                	jne    8f0 <thread_creator+0x40>
        stack = fptr;
    else
 ...
 8d8:	53                   	push   %ebx
 8d9:	e8 7d fb ff ff       	call   45b <thread_create>

    if (thread_id < 0)
 8de:	83 c4 10             	add    $0x10,%esp
 8e1:	85 c0                	test   %eax,%eax
 8e3:	78 23                	js     908 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
 8e5:	74 45                	je     92c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
 ...
 8f2:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
 8f5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 8fb:	53                   	push   %ebx
 8fc:	e8 5a fb ff ff       	call   45b <thread_create>
    if (thread_id < 0)
 901:	83 c4 10             	add    $0x10,%esp
 904:	85 c0                	test   %eax,%eax
 906:	79 dd                	jns    8e5 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
 908:	83 ec 08             	sub    $0x8,%esp
 90b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 90e:	68 59 0a 00 00       	push   $0xa59
 913:	6a 01                	push   $0x1
 915:	e8 26 fc ff ff       	call   540 <printf>
 91a:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
 91d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 920:	83 c4 10             	add    $0x10,%esp
 923:	c9                   	leave  
 924:	c3                   	ret    
        return -1;
 925:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 92a:	eb bb                	jmp    8e7 <thread_creator+0x37>
        (fn)(args);
 92c:	83 ec 0c             	sub    $0xc,%esp
 92f:	ff 75 0c             	pushl  0xc(%ebp)
 932:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
 935:	89 1c 24             	mov    %ebx,(%esp)
 938:	e8 d3 fd ff ff       	call   710 <free>
        exit();
 93d:	e8 61 fa ff ff       	call   3a3 <exit>
