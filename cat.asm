 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 54 09 00 00 	movzbl 0x954(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb 4c 09 00 00       	mov    $0x94c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 80 0c 00 00       	mov    0xc80,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 80 0c 00 00       	mov    %eax,0xc80
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 80 0c 00 00       	mov    %eax,0xc80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d 80 0c 00 00    	mov    0xc80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d 80 0c 00 00    	mov    0xc80,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 80 0c 00 00       	mov    0xc80,%eax
 ...
 83e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 80 0c 00 00 84 	movl   $0xc84,0xc80
 847:	0c 00 00 
    base.s.size = 0;
 84a:	bf 84 0c 00 00       	mov    $0xc84,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 84 0c 00 00 84 	movl   $0xc84,0xc84
 856:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 88 0c 00 00 00 	movl   $0x0,0xc88
 862:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 8a8:	53                   	push   %ebx
 8a9:	e8 7d fb ff ff       	call   42b <thread_create>
 ...
 8c5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 8cb:	53                   	push   %ebx
 8cc:	e8 5a fb ff ff       	call   42b <thread_create>
    if (thread_id < 0)
 ...
 908:	e8 d3 fd ff ff       	call   6e0 <free>
        exit();
 90d:	e8 61 fa ff ff       	call   373 <exit>
