...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 8b 08 00 00       	mov    $0x88b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 88 0b 00 00       	mov    %eax,0xb88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 88 0b 00 00       	mov    0xb88,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 7b2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 7d7:	53                   	push   %ebx
 7d8:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
 7db:	68 00 20 00 00       	push   $0x2000
 7e0:	e8 db fe ff ff       	call   6c0 <malloc>
    void *stack;

    if (fptr == 0)
 7e5:	83 c4 10             	add    $0x10,%esp
 7e8:	85 c0                	test   %eax,%eax
 7ea:	74 59                	je     845 <thread_creator+0x75>
 ...
 7f3:	75 1b                	jne    810 <thread_creator+0x40>
        stack = fptr;
    else
 ...
 7f8:	53                   	push   %ebx
 7f9:	e8 7d fb ff ff       	call   37b <thread_create>

    if (thread_id < 0)
 7fe:	83 c4 10             	add    $0x10,%esp
 801:	85 c0                	test   %eax,%eax
 803:	78 23                	js     828 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
 805:	74 45                	je     84c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
 ...
 812:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
 815:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 81b:	53                   	push   %ebx
 81c:	e8 5a fb ff ff       	call   37b <thread_create>
    if (thread_id < 0)
 821:	83 c4 10             	add    $0x10,%esp
 824:	85 c0                	test   %eax,%eax
 826:	79 dd                	jns    805 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
 828:	83 ec 08             	sub    $0x8,%esp
 82b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 82e:	68 a5 08 00 00       	push   $0x8a5
 833:	6a 01                	push   $0x1
 835:	e8 26 fc ff ff       	call   460 <printf>
 ...
 844:	c3                   	ret    
        return -1;
 845:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 84a:	eb bb                	jmp    807 <thread_creator+0x37>
        (fn)(args);
 84c:	83 ec 0c             	sub    $0xc,%esp
 84f:	ff 75 0c             	pushl  0xc(%ebp)
 852:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
 855:	89 1c 24             	mov    %ebx,(%esp)
 858:	e8 d3 fd ff ff       	call   630 <free>
        exit();
 85d:	e8 61 fa ff ff       	call   2c3 <exit>
