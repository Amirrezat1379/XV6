...
_threadsTest:     file format elf32-i386
...
int main(void) {
  16:	83 ec 18             	sub    $0x18,%esp
    int argument = 0x0F01;
  19:	c7 45 f4 01 0f 00 00 	movl   $0xf01,-0xc(%ebp)
    int thread_id = thread_creator(&childPrint, (void*)&argument);
  20:	50                   	push   %eax
  21:	68 70 00 00 00       	push   $0x70
  26:	e8 d5 07 00 00       	call   800 <thread_creator>
    if (thread_id < 0)
  ...
  32:	78 1a                	js     4e <main+0x4e>
        printf(1, "failed\n");
    
    join();
  34:	e8 7a 03 00 00       	call   3b3 <join>

    printf(1, "tread id is: %d\n", thread_id);
  39:	83 ec 04             	sub    $0x4,%esp
  3c:	53                   	push   %ebx
  3d:	68 aa 08 00 00       	push   $0x8aa
  42:	6a 01                	push   $0x1
  44:	e8 47 04 00 00       	call   490 <printf>

    exit();
  49:	e8 a5 02 00 00       	call   2f3 <exit>
        printf(1, "failed\n");
  4e:	50                   	push   %eax
  4f:	50                   	push   %eax
  50:	68 a2 08 00 00       	push   $0x8a2
  55:	6a 01                	push   $0x1
  57:	e8 34 04 00 00       	call   490 <printf>
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	eb d3                	jmp    34 <main+0x34>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb bb 08 00 00       	mov    $0x8bb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 ...
 7be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf dc 0b 00 00       	mov    $0xbdc,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 7e2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 807:	53                   	push   %ebx
 808:	83 ec 20             	sub    $0x20,%esp
    void *fptr = malloc(2 * PAGESIZE);
 80b:	68 00 20 00 00       	push   $0x2000
 810:	e8 db fe ff ff       	call   6f0 <malloc>
    void *stack;

    if (fptr == 0)
 815:	83 c4 10             	add    $0x10,%esp
 818:	85 c0                	test   %eax,%eax
 81a:	74 59                	je     875 <thread_creator+0x75>
 81c:	89 c3                	mov    %eax,%ebx
    ...
    if (mod == 0)
 81e:	25 ff 0f 00 00       	and    $0xfff,%eax
 823:	75 1b                	jne    840 <thread_creator+0x40>
        stack = fptr;
    else
 ...
 828:	53                   	push   %ebx
 829:	e8 7d fb ff ff       	call   3ab <thread_create>

    if (thread_id < 0)
 82e:	83 c4 10             	add    $0x10,%esp
 831:	85 c0                	test   %eax,%eax
 833:	78 23                	js     858 <thread_creator+0x58>
        printf(1, "Thread create faild :( !\n");
    else if (thread_id == 0) {
 835:	74 45                	je     87c <thread_creator+0x7c>
        (fn)(args);
        free(stack);
        exit();
    }
 ...
 842:	83 ec 0c             	sub    $0xc,%esp
        stack = fptr + (PAGESIZE - mod);
 845:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 84b:	53                   	push   %ebx
 84c:	e8 5a fb ff ff       	call   3ab <thread_create>
    if (thread_id < 0)
 851:	83 c4 10             	add    $0x10,%esp
 854:	85 c0                	test   %eax,%eax
 856:	79 dd                	jns    835 <thread_creator+0x35>
        printf(1, "Thread create faild :( !\n");
 858:	83 ec 08             	sub    $0x8,%esp
 85b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 85e:	68 d5 08 00 00       	push   $0x8d5
 863:	6a 01                	push   $0x1
 865:	e8 26 fc ff ff       	call   490 <printf>
 ...
 87a:	eb bb                	jmp    837 <thread_creator+0x37>
        (fn)(args);
 87c:	83 ec 0c             	sub    $0xc,%esp
 87f:	ff 75 0c             	pushl  0xc(%ebp)
 882:	ff 55 08             	call   *0x8(%ebp)
        free(stack);
 885:	89 1c 24             	mov    %ebx,(%esp)
 888:	e8 d3 fd ff ff       	call   660 <free>
        exit();
 88d:	e8 61 fa ff ff       	call   2f3 <exit>
