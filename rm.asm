 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb b1 08 00 00       	mov    $0x8b1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 b8 0b 00 00       	mov    %eax,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 b8 0b 00 00       	mov    0xbb8,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf bc 0b 00 00       	mov    $0xbbc,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 7d2:	00 00 00 
    if(p->s.size >= nunits){
