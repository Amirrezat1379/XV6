 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb d1 08 00 00       	mov    $0x8d1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf dc 0b 00 00       	mov    $0xbdc,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_creator (void (*fn) (void *), void *args) {
 ...
 838:	53                   	push   %ebx
 839:	e8 5d fb ff ff       	call   39b <thread_create>
 ...
 855:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    int thread_id = thread_create((void*)stack);
 85b:	53                   	push   %ebx
 85c:	e8 3a fb ff ff       	call   39b <thread_create>
    if (thread_id < 0)
 ...
 898:	e8 d3 fd ff ff       	call   670 <free>
        exit();
 89d:	e8 41 fa ff ff       	call   2e3 <exit>
