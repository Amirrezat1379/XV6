...
printf(int fd, const char *fmt, ...)
{
 ...
 734:	eb 1a                	jmp    750 <printf+0x1a0>
          s = "(null)";
 736:	bb eb 09 00 00       	mov    $0x9eb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 7a6:	73 10                	jae    7b8 <free+0x38>
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 7d7:	5e                   	pop    %esi
 7d8:	5f                   	pop    %edi
 7d9:	5d                   	pop    %ebp
 ...
 7f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7fa:	a3 40 0d 00 00       	mov    %eax,0xd40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 81d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 820:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 869:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
 ...
 892:	e8 e9 fe ff ff       	call   780 <free>
  return freep;
 897:	a1 40 0d 00 00       	mov    0xd40,%eax
 ...
 8c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8c7:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 ...
 8de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 40 0d 00 00 44 	movl   $0xd44,0xd40
 8e7:	0d 00 00 
    base.s.size = 0;
 8ea:	bf 44 0d 00 00       	mov    $0xd44,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 8f6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8fb:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 902:	00 00 00 
    if(p->s.size >= nunits){
